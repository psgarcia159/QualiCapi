...
Begin VB.Form TelaAssistencia 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      Bindings        =   "TelaAssistencia.frx":0000
      Height          =   3270
      Left            =   120
      TabIndex        =   0
      Top             =   0
      ...
      Columns(1).Caption=   "Imóvel"
      Columns(1).DataField=   "imov_cd_Imovel"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Contrato"
      Columns(2).DataField=   "cont_cd_Contrato"
      ...
      Splits(0)._ColumnProps(17)=   "Column(2)._ColStyle=8721"
      ...
      Splits(0)._ColumnProps(31)=   "Column(5).Width=9710"
      Splits(0)._ColumnProps(32)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(33)=   "Column(5)._WidthInPix=9631"
      ...
      Splits(0)._ColumnProps(43)=   "Column(7).Width=1799"
      Splits(0)._ColumnProps(44)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(45)=   "Column(7)._WidthInPix=1720"
      ...
      Splits(0)._ColumnProps(51)=   "Column(8)._WidthInPix=1323"
      Splits(0)._ColumnProps(52)=   "Column(8)._EditAlways=0"
      Splits(0)._ColumnProps(53)=   "Column(8)._ColStyle=529"
      ...
      _StyleDefs(32)  =   "Splits(0).Columns(0).Style:id=28,.parent=13,.alignment=2,.valignment=2"
      ...
      _StyleDefs(41)  =   "Splits(0).Columns(2).Style:id=46,.parent=13,.alignment=2,.locked=-1"
      ...
      _StyleDefs(49)  =   "Splits(0).Columns(4).Style:id=62,.parent=13,.alignment=2"
      _StyleDefs(50)  =   "Splits(0).Columns(4).HeadingStyle:id=59,.parent=14"
      _StyleDefs(51)  =   "Splits(0).Columns(4).FooterStyle:id=60,.parent=15"
      _StyleDefs(52)  =   "Splits(0).Columns(4).EditorStyle:id=61,.parent=17"
      _StyleDefs(53)  =   "Splits(0).Columns(5).Style:id=74,.parent=13,.alignment=2"
      _StyleDefs(54)  =   "Splits(0).Columns(5).HeadingStyle:id=71,.parent=14"
      _StyleDefs(55)  =   "Splits(0).Columns(5).FooterStyle:id=72,.parent=15"
      _StyleDefs(56)  =   "Splits(0).Columns(5).EditorStyle:id=73,.parent=17"
      _StyleDefs(57)  =   "Splits(0).Columns(6).Style:id=50,.parent=13,.alignment=2"
      _StyleDefs(58)  =   "Splits(0).Columns(6).HeadingStyle:id=47,.parent=14"
      _StyleDefs(59)  =   "Splits(0).Columns(6).FooterStyle:id=48,.parent=15"
      _StyleDefs(60)  =   "Splits(0).Columns(6).EditorStyle:id=49,.parent=17"
      _StyleDefs(61)  =   "Splits(0).Columns(7).Style:id=66,.parent=13,.alignment=2"
      ...
      _StyleDefs(65)  =   "Splits(0).Columns(8).Style:id=54,.parent=13,.alignment=2"
      _StyleDefs(66)  =   "Splits(0).Columns(8).HeadingStyle:id=51,.parent=14"
      _StyleDefs(67)  =   "Splits(0).Columns(8).FooterStyle:id=52,.parent=15"
      _StyleDefs(68)  =   "Splits(0).Columns(8).EditorStyle:id=53,.parent=17"
   ...
   Begin Threed.SSPanel PanBotoes 
      ...
      Begin MSDataListLib.DataCombo cboLocalizar 
         Bindings        =   "TelaAssistencia.frx":0015
         Height          =   315
         Left            =   3060
         TabIndex        =   6
         Top             =   0
   ...
   End
End
Attribute VB_Name = "TelaAssistencia"
...
'    If Not FunVerifica_Permissao(Me.Name, "1") Then
 ...
 '   End If
    ...
    Chave = Adodc1.Recordset("empd_cd_empreendimento") & "." & _
        Adodc1.Recordset("imov_cd_imovel") & "." & _
        Adodc1.Recordset("cont_cd_contrato") & "." & _
        Format(Adodc1.Recordset("assi_cd_assistencia"), "#")
    
    FrmSolAssistencia.Show 1
    
      subCarregaDadosNV Adodc1, "", "assi_cd_CodigoSeq", _
                            "", "SELECT * FROM ConsCapAssistenciaTecnica WHERE empr_cd_empresa = " & PCodEmpresa & " AND empd_cd_Empreendimento='" & XFT_CODEMPREENDIMENTO & "' AND imov_cd_Imovel= '" & XFT_CODIMOVEL & "' AND cont_cd_contrato = '" & XFT_CODCONTRATO & "' "
...
'If Not FunVerifica_Permissao(Me.Name, "4") Then
 ...
 '   End If
    ...
    If XLI_OPCAO = 1 Then  'Confirma exclusão
      ...
      XGT_SQL = "DELETE FROM AssistenciaTecnica WHERE empr_cd_Empresa=" & PCodEmpresa & " AND imov_cd_imovel ='" & XFT_CODIMOVEL & "' AND empd_cd_Empreendimento= '" & XFT_CODEMPREENDIMENTO & "' AND cont_cd_Contrato= '" & XFT_CODCONTRATO & "' AND assi_cd_Assistencia= '" & XLT_ASSISTENCIA & "' "
...
Private Sub CmdFormulario_Click()
    ...
    Set XGO_RSRELATORIO = ConexaoRelatorio.Execute("SELECT * FROM ConsCAPAssistenciaTecnica WHERE " & XGT_SELECAO)
...
Private Sub CmdInserir_Click()
  ...
  If Adodc1.Recordset.EOF Then
    ...
    End If
  If FunLocalizaJanelasAtivas("FrmSolAssistencia") <> -1 Then
...
Private Sub Form_Load()
    ...
    Set Formulario = TelaAssistencia
