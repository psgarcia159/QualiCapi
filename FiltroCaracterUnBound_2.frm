VERSION 5.00
Begin VB.Form FiltroCaracterUnBound 
   ...
   End
End
Attribute VB_Name = "FiltroCaracterUnBound"
...
Private Sub botao_conf_Click()
    ...
    If Trim$(text1.Text) <> "" Then
       FiltroCaracterUnBound.MousePointer = vbHourglass
...
'       controledadosfiltro.Refresh
       ...
       FiltroCaracterUnBound.MousePointer = vbDefault
       Unload Me
    Else
