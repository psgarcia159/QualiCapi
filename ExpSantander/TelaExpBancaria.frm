...
Begin VB.Form TelaExpBancaria 
   Caption         =   "Exportação Bancária - SANTANDER"
   ClientHeight    =   5835
   ClientLeft      =   615
   ClientTop       =   330
   ClientWidth     =   9360
   ...
   Begin Threed.SSPanel PanPesquisa 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(13)=   "CboSegundaInstrucaoCobranca"
         Tab(0).Control(13).Enabled=   0   'False
         Tab(0).Control(14)=   "DatContaCorrenteCobranca"
         Tab(0).Control(14).Enabled=   0   'False
         Tab(0).Control(15)=   "cboContaCorrenteCobranca"
         Tab(0).Control(15).Enabled=   0   'False
         Tab(0).Control(16)=   "DatObs"
         Tab(0).Control(16).Enabled=   0   'False
         Tab(0).Control(17)=   "DatTipoPlano"
         Tab(0).Control(17).Enabled=   0   'False
         Tab(0).Control(18)=   "DatContaCorrenteMovimento"
         Tab(0).Control(18).Enabled=   0   'False
         Tab(0).Control(19)=   "cboContaCorrenteMovimento"
         Tab(0).Control(19).Enabled=   0   'False
         Tab(0).Control(20)=   "CmdLimparNaturezaPlano"
         Tab(0).Control(20).Enabled=   0   'False
         Tab(0).Control(21)=   "CboTiposPlanos"
         Tab(0).Control(21).Enabled=   0   'False
         Tab(0).Control(22)=   "CmdLimparTipoPlano"
         Tab(0).Control(22).Enabled=   0   'False
         Tab(0).Control(23)=   "DtpExportacao"
         Tab(0).Control(23).Enabled=   0   'False
         Tab(0).Control(24)=   "DtpVencimento"
         Tab(0).Control(24).Enabled=   0   'False
         Tab(0).Control(25)=   "TxtMensagem1"
         Tab(0).Control(25).Enabled=   0   'False
         Tab(0).Control(26)=   "TxtMensagem2"
         Tab(0).Control(26).Enabled=   0   'False
         Tab(0).Control(27)=   "CboNaturezasPlanos"
         Tab(0).Control(27).Enabled=   0   'False
         Tab(0).Control(28)=   "CboTipoCobranca"
         Tab(0).Control(28).Enabled=   0   'False
         Tab(0).Control(29)=   "CboPrimeiraInstrucaoCobranca"
         Tab(0).Control(29).Enabled=   0   'False
         Tab(0).Control(30)=   "TxtDiasProtesto"
         Tab(0).Control(30).Enabled=   0   'False
         Tab(0).Control(31)=   "txtCodigoTransmissao"
         ...
         Begin VB.TextBox txtCodigoTransmissao 
            Height          =   300
            Left            =   1965
            MaxLength       =   20
            TabIndex        =   12
         ...
         Begin VB.TextBox TxtDiasProtesto 
            ...
            Width           =   585
         End
         Begin VB.ComboBox CboPrimeiraInstrucaoCobranca 
            Height          =   315
            ItemData        =   "TelaExpBancaria.frx":093A
            Left            =   1965
            List            =   "TelaExpBancaria.frx":0953
            TabIndex        =   9
            Top             =   3480
            Width           =   3735
         End
         Begin VB.ComboBox CboTipoCobranca 
            Height          =   315
            ItemData        =   "TelaExpBancaria.frx":0A14
            Left            =   1965
            List            =   "TelaExpBancaria.frx":0A24
            TabIndex        =   8
            Top             =   3120
            Width           =   3735
         End
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "TelaExpBancaria.frx":0AA4
            Left            =   1965
            List            =   "TelaExpBancaria.frx":0ABA
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "TelaExpBancaria.frx":0AF5
            Picture         =   "TelaExpBancaria.frx":0B11
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "TelaExpBancaria.frx":0C23
            Height          =   315
            Left            =   1965
            TabIndex        =   2
            Top             =   840
         ...
         End
         Begin MSDataListLib.DataCombo cboContaCorrenteMovimento 
            ...
            EndProperty
         End
         Begin MSAdodcLib.Adodc DatContaCorrenteMovimento 
            Height          =   330
            Left            =   6120
            Top             =   1260
            Visible         =   0   'False
            ...
            Password        =   ""
            RecordSource    =   ""
            Caption         =   "DatContaCorrenteMovimento"
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin TrueDBGrid70.TDBGrid TDBGridMoeda2 
            ...
            _StyleDefs(63)  =   ":id=42,.parent=33"
         End
         Begin MSDataListLib.DataCombo cboContaCorrenteCobranca 
            Bindings        =   "TelaExpBancaria.frx":0D94
            Height          =   330
            Left            =   1965
            TabIndex        =   5
            Top             =   2040
            ...
            EndProperty
         End
         Begin MSAdodcLib.Adodc DatContaCorrenteCobranca 
            Height          =   330
            Left            =   5880
            Top             =   3120
            Visible         =   0   'False
            ...
            Password        =   ""
            RecordSource    =   ""
            Caption         =   "DatContaCorrenteCobranca"
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            _Version        =   393216
         End
         Begin VB.ComboBox CboSegundaInstrucaoCobranca 
            Height          =   315
            ItemData        =   "TelaExpBancaria.frx":0DBB
            Left            =   1965
            List            =   "TelaExpBancaria.frx":0DD4
            TabIndex        =   10
            Top             =   3840
            Width           =   3735
         End
   ...
   Begin TrueDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(1)._ColumnProps(0)=   "Columns.Count=11"
      ...
      _StyleDefs(80)  =   "Splits(1).Style:id=13,.parent=1,.valignment=2,.wraptext=-1"
      _StyleDefs(81)  =   "Splits(1).CaptionStyle:id=22,.parent=4"
      _StyleDefs(82)  =   "Splits(1).HeadingStyle:id=14,.parent=2"
      _StyleDefs(83)  =   "Splits(1).FooterStyle:id=15,.parent=3"
      _StyleDefs(84)  =   "Splits(1).InactiveStyle:id=16,.parent=5"
      _StyleDefs(85)  =   "Splits(1).SelectedStyle:id=18,.parent=6"
      _StyleDefs(86)  =   "Splits(1).EditorStyle:id=17,.parent=7"
      _StyleDefs(87)  =   "Splits(1).HighlightRowStyle:id=19,.parent=8,.bgcolor=&H800000&"
      _StyleDefs(88)  =   "Splits(1).EvenRowStyle:id=20,.parent=9"
      _StyleDefs(89)  =   "Splits(1).OddRowStyle:id=21,.parent=10"
      _StyleDefs(90)  =   "Splits(1).RecordSelectorStyle:id=23,.parent=11"
      _StyleDefs(91)  =   "Splits(1).FilterBarStyle:id=24,.parent=12"
      _StyleDefs(92)  =   "Splits(1).Columns(0).Style:id=28,.parent=13,.alignment=2,.locked=-1"
      _StyleDefs(93)  =   "Splits(1).Columns(0).HeadingStyle:id=25,.parent=14,.alignment=2"
      _StyleDefs(94)  =   "Splits(1).Columns(0).FooterStyle:id=26,.parent=15"
      _StyleDefs(95)  =   "Splits(1).Columns(0).EditorStyle:id=27,.parent=17"
      _StyleDefs(96)  =   "Splits(1).Columns(1).Style:id=46,.parent=13,.alignment=2"
      _StyleDefs(97)  =   "Splits(1).Columns(1).HeadingStyle:id=43,.parent=14,.alignment=2"
      _StyleDefs(98)  =   "Splits(1).Columns(1).FooterStyle:id=44,.parent=15"
      _StyleDefs(99)  =   "Splits(1).Columns(1).EditorStyle:id=45,.parent=17"
      _StyleDefs(100) =   "Splits(1).Columns(2).Style:id=50,.parent=13,.alignment=2,.locked=-1"
      _StyleDefs(101) =   "Splits(1).Columns(2).HeadingStyle:id=47,.parent=14,.alignment=2"
      _StyleDefs(102) =   "Splits(1).Columns(2).FooterStyle:id=48,.parent=15"
      _StyleDefs(103) =   "Splits(1).Columns(2).EditorStyle:id=49,.parent=17"
      _StyleDefs(104) =   "Splits(1).Columns(3).Style:id=58,.parent=13,.alignment=1,.locked=-1"
      _StyleDefs(105) =   "Splits(1).Columns(3).HeadingStyle:id=55,.parent=14,.alignment=2"
      _StyleDefs(106) =   "Splits(1).Columns(3).FooterStyle:id=56,.parent=15"
      _StyleDefs(107) =   "Splits(1).Columns(3).EditorStyle:id=57,.parent=17"
      _StyleDefs(108) =   "Splits(1).Columns(4).Style:id=62,.parent=13,.alignment=0,.locked=-1"
      _StyleDefs(109) =   "Splits(1).Columns(4).HeadingStyle:id=59,.parent=14,.alignment=2"
      _StyleDefs(110) =   "Splits(1).Columns(4).FooterStyle:id=60,.parent=15"
      _StyleDefs(111) =   "Splits(1).Columns(4).EditorStyle:id=61,.parent=17"
      _StyleDefs(112) =   "Splits(1).Columns(5).Style:id=66,.parent=13,.alignment=1,.locked=-1"
      _StyleDefs(113) =   "Splits(1).Columns(5).HeadingStyle:id=63,.parent=14,.alignment=1"
      _StyleDefs(114) =   "Splits(1).Columns(5).FooterStyle:id=64,.parent=15"
      _StyleDefs(115) =   "Splits(1).Columns(5).EditorStyle:id=65,.parent=17"
      _StyleDefs(116) =   "Splits(1).Columns(6).Style:id=70,.parent=13,.alignment=2,.locked=0"
      _StyleDefs(117) =   "Splits(1).Columns(6).HeadingStyle:id=67,.parent=14,.alignment=2"
      _StyleDefs(118) =   "Splits(1).Columns(6).FooterStyle:id=68,.parent=15"
      _StyleDefs(119) =   "Splits(1).Columns(6).EditorStyle:id=69,.parent=17"
      _StyleDefs(120) =   "Splits(1).Columns(7).Style:id=74,.parent=13,.alignment=1,.locked=0"
      _StyleDefs(121) =   "Splits(1).Columns(7).HeadingStyle:id=71,.parent=14,.alignment=2"
      _StyleDefs(122) =   "Splits(1).Columns(7).FooterStyle:id=72,.parent=15"
      _StyleDefs(123) =   "Splits(1).Columns(7).EditorStyle:id=73,.parent=17"
      _StyleDefs(124) =   "Splits(1).Columns(8).Style:id=86,.parent=13,.alignment=1"
      _StyleDefs(125) =   "Splits(1).Columns(8).HeadingStyle:id=83,.parent=14"
      _StyleDefs(126) =   "Splits(1).Columns(8).FooterStyle:id=84,.parent=15"
      _StyleDefs(127) =   "Splits(1).Columns(8).EditorStyle:id=85,.parent=17"
      _StyleDefs(128) =   "Splits(1).Columns(9).Style:id=90,.parent=13"
      _StyleDefs(129) =   "Splits(1).Columns(9).HeadingStyle:id=87,.parent=14"
      _StyleDefs(130) =   "Splits(1).Columns(9).FooterStyle:id=88,.parent=15"
      _StyleDefs(131) =   "Splits(1).Columns(9).EditorStyle:id=89,.parent=17"
      _StyleDefs(132) =   "Splits(1).Columns(10).Style:id=54,.parent=13"
      _StyleDefs(133) =   "Splits(1).Columns(10).HeadingStyle:id=51,.parent=14"
      _StyleDefs(134) =   "Splits(1).Columns(10).FooterStyle:id=52,.parent=15"
      _StyleDefs(135) =   "Splits(1).Columns(10).EditorStyle:id=53,.parent=17"
...
Sub SubCalculaValorAtualizado()
  ...
  'If XFO_EXPORTACAO(0) = "0001.3010.01.01.001.00" Then
...
Private Sub CboPrimeiraInstrucaoCobranca_Change()

        If (Trim(Mid(CboPrimeiraInstrucaoCobranca.Text, 1, 3)) = "06") Then
            TxtDiasProtesto.Enabled = True
        Else
            TxtDiasProtesto.Enabled = False
        End If
End Sub

Private Sub CboSegundaInstrucaoCobranca_Change()
        If (Trim(Mid(CboSegundaInstrucaoCobranca.Text, 1, 3)) = "06") Then
            TxtDiasProtesto.Enabled = True
        Else
            TxtDiasProtesto.Enabled = False
        End If
...
Private Sub CmdExportar_Click()
  ...
  Dim XLT_CODIGOTRANSMISSAO As Integer
  Dim XLI_QUANTIDADEDOCUMENTOS As Integer
  Dim XLF_VALORTOTAL As Double
  ...
  Dim XLT_DIASPROTESTO As String
  
  Dim XLT_PRIMEIRAINSTRUCAO As String
  Dim XLT_SEGUNDAINSTRUCAO As String
...
'  If DatContaCorrenteMovimento.Recordset.Fields!coco_nr_conveniocobranca = "" Then
'    MsgBox "Favor incluir o código do convênio no cadastro de conta corrente.", vbInformation, "EXPORTAÇÃO"
'    Exit Sub
'  End If
  
  DlgSalvar.DialogTitle = "Arquivo de Exportação do SANTANDER"
  DlgSalvar.Filter = "Arquivo de Remessa do Santander (*.txt)|*.txt"
  DlgSalvar.DefaultExt = "txt"
  DlgSalvar.FileName = "Arquivo_Remessa_Santander_" & Format(DateTime.Now, "ddmmyy")
  ...
  XLT_SQL = "SELECT coco_nr_arqcobranca FROM ContasCorrente WHERE coco_cd_codigo = " & DatContaCorrenteMovimento.Recordset.Fields!coco_cd_codigo & " AND empr_cd_empresa = " & PCodEmpresa & " ORDER BY coco_cd_codigo DESC"
  ...
  Conexao.Execute "UPDATE ContasCorrente SET coco_nr_arqcobranca = " & XLI_ARQUIVO & " WHERE coco_cd_codigo = " & DatContaCorrenteMovimento.Recordset.Fields!coco_cd_codigo & " AND empr_cd_empresa = " & PCodEmpresa
  
  'CGC DA EMPRESA
  XLT_CGCEMP = Mid(XGT_CGC, 1, 2) + Mid(XGT_CGC, 4, 3) + Mid(XGT_CGC, 8, 3) + Mid(XGT_CGC, 12, 4) + Mid(XGT_CGC, 17, 2)
  
  '**********HEADER DE ARQUIVO**********
  'PADRÃO CNAB 400 POSIÇÕES SANTANDER BANESPA (033-7) VERSÃO 2.0 - OUTUBRO/2009
  
  XLI_QUANTIDADEDOCUMENTOS = XLI_QUANTIDADEDOCUMENTOS + 1
  ...
  XLT_TEXTO = "0" & _
              ...
              "01" & _
              "COBRANÇA       " & _
              Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_nr_conveniocobranca, 8), "00000000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_conta, 7), "00000000") & _
              Left(PEmpresa, 30) & Space(30 - Len(Left(PEmpresa, 30))) & _
              "033" & _
              "SANTANDER      " & _
              Format(Now, "ddMMyy") & _
              "0000000000000000" & _
              Left(TxtMensagem1.Text, 47) & Space(47 - Len(Left(TxtMensagem1.Text, 47))) & _
              Left(TxtMensagem2.Text, 47) & Space(47 - Len(Left(TxtMensagem2.Text, 47))) & _
              Space(181) & _
              "000" & _
              Format(XLI_ARQUIVO, "000000")
              
  'Codigo de Transmissão
  'Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_ContaMovimento, 8), "00000000") & Space(20 - Len(Left((Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_ContaMovimento, 8), "00000000")), 20))) & _

  Print #1, funTiraAcento(XLT_TEXTO, True)
  
  'No lugar foi colocado XLI_ARQUIVO no Header de Lote conforme solicitado por Diego da Costa Andrade
  XLI_NUMSQUENCIAL = 1
  ...
  While Not TDBGrid1.EOF
      ...
      If TDBGrid1.Columns("Exp.").Value = "-1" Then
          ...
          XLF_VALORTOTAL = XLF_VALORTOTAL + XLF_VALOR
          ...
          If (XFO_EXPORTACAO!titu_dt_Vencimento <> "") Then
            XLT_DATAMORA = Format(DateAdd("d", 1, XFO_EXPORTACAO!titu_dt_Vencimento), "ddmmyy")
          Else
            XLT_DATAMORA = "000000"
          End If
          ...
          SubQOpenRecordset XLO_BLOCO, XLT_SQL, Dinamico
            ...
            If XLO_BLOCO.EOF Or XLO_BLOCO!empd_nr_bloco = "" Then
                XLT_BLOCO = 0
            Else
        ...
        If (CboPrimeiraInstrucaoCobranca.Text <> "") Then
            XLT_PRIMEIRAINSTRUCAO = Trim(Mid(CboPrimeiraInstrucaoCobranca.Text, 1, 3))
        Else
            XLT_PRIMEIRAINSTRUCAO = "00"
        End If
        If (CboSegundaInstrucaoCobranca.Text <> "") Then
            XLT_SEGUNDAINSTRUCAO = Trim(Mid(CboSegundaInstrucaoCobranca.Text, 1, 3))
        Else
            XLT_SEGUNDAINSTRUCAO = "00"
        End If
        
        XLT_DIASPROTESTO = "0"
        If (XLT_PRIMEIRAINSTRUCAO = "06" Or XLT_SEGUNDAINSTRUCAO = "06") Then
            XLT_DIASPROTESTO = TxtDiasProtesto.Text
        Else
            XLT_DIASPROTESTO = "0"
        End If
        ...
        End If
          ...
          XLT_TEXTO = _
                ...
                Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_nr_conveniocobranca, 8), "00000000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_conta, 7), "00000000") & _
                Replace(Replace(XFO_EXPORTACAO!Titulo, ".", "") & Space(25 - Len(Replace(XFO_EXPORTACAO!Titulo, ".", ""))), ".", "") & _
                "00000000" & _
                "000000" & _
                Space(1) & _
                "4" & _
                Replace(Format(XFO_EXPORTACAO!titu_vl_PercMultaMora, "00.00"), ",", "") & _
                "00" & _
                "0000000000000" & _
                Space(4) & _
                XLT_DATAMORA & _
                CStr(XLI_TIPOCOBRANCA) & _
                "01" & _
                Format(FunNuloVal(XFO_EXPORTACAO!nofi_nr_documento), "0000000000") & _
                Format(XFO_EXPORTACAO!titu_dt_Vencimento, "ddmmyy") & _
                Format(XLF_VALOR * 100, "0000000000000")

                'Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & _
                'Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_ContaMovimento, 8), "00000000") & _
                'Format(Left(DatContaCorrenteCobranca.Recordset.Fields!coco_tx_Conta, 7), "00000000") & _
         ...
         XLT_TEXTO = XLT_TEXTO & _
                ...
                "01" & _
                "N" & _
                Format(XFO_EXPORTACAO!titu_dt_Criacao, "ddmmyy") & _
                XLT_PRIMEIRAINSTRUCAO & _
                XLT_SEGUNDAINSTRUCAO & _
                Format((XFO_EXPORTACAO!titu_vl_PercMultaMora / 100#) * XLF_VALOR, "0000000000000") & _
                XLT_DATADESCONTO
         ...
         XLT_TEXTO = XLT_TEXTO & _
               Format(XLF_DESCONTO * 100, "0000000000000") & _
                ...
                Space(1) & _
                "I" & _
                Format(Right(DatContaCorrenteCobranca.Recordset.Fields!coco_tx_conta, 1)) & Format(Right(DatContaCorrenteCobranca.Recordset.Fields!coco_nr_Dac, 1)) & _
                Space(6) & _
                Format(XLT_DIASPROTESTO, "00") & _
                Space(1) & _
          ...
          Dim XLT_NATUREZAPLANO As String
         ...
         'Natureza
          If XFO_EXPORTACAO!titu_tx_NaturezaPlano = "S" Then
            XLT_NATUREZAPLANO = " SINAL"
          ElseIf XFO_EXPORTACAO!titu_tx_NaturezaPlano = "P" Then
            XLT_NATUREZAPLANO = " POUPANCA"
          ElseIf XFO_EXPORTACAO!titu_tx_NaturezaPlano = "F" Then
            XLT_NATUREZAPLANO = " FINANCIAM"
          ElseIf XFO_EXPORTACAO!titu_tx_NaturezaPlano = "G" Then
            XLT_NATUREZAPLANO = " FGTS"
          ElseIf XFO_EXPORTACAO!titu_tx_NaturezaPlano = "O" Then
            XLT_NATUREZAPLANO = " OUTROS"
          ElseIf XFO_EXPORTACAO!titu_tx_NaturezaPlano = "V" Then
            XLT_NATUREZAPLANO = " A VISTA"
          End If
          
          XLT_MENSAGEMVARIAVELTITULO = "Quadra " & Mid(XFO_EXPORTACAO!Titulo, 6, 2) & " Lote " & Mid(XFO_EXPORTACAO!Titulo, 8, 2) & " Parcela " & Mid(XFO_EXPORTACAO!Titulo, 17, 3) & XLT_NATUREZAPLANO & XLT_RESIDUOPARCELA
          
          'Registro Movimento - Remessa - mensagem variável p/ título (opicional)
          XLT_TEXTO = _
                "2" & _
                Space(16) & _
                Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_nr_conveniocobranca, 8), "00000000") & Format(Left(DatContaCorrenteMovimento.Recordset.Fields!coco_tx_conta, 7), "00000000") & _
                Space(10) & _
                "01" & _
                Left(XLT_MENSAGEMVARIAVELTITULO, 50) & Space(50 - Len(Left(XLT_MENSAGEMVARIAVELTITULO, 50))) & _
                Space(283) & _
                "I" & _
                Format(Right(DatContaCorrenteCobranca.Recordset.Fields!coco_tx_conta, 1)) & Format(Right(DatContaCorrenteCobranca.Recordset.Fields!coco_nr_Dac, 1)) & _
                Space(9) & _
          ...
          Conexao.Execute ("UPDATE Titulos Set titu_tx_ExpBanco='S'," & _
            ...
            XGM_MATRIZLOG(5, 1) = DatContaCorrenteMovimento.Recordset.Fields!coco_cd_Agencia & " - " & DatContaCorrenteMovimento.Recordset.Fields!coco_tx_conta & "-" & FunNuloVal(DatContaCorrenteMovimento.Recordset.Fields!coco_nr_Dag)
            XGM_MATRIZLOG(6, 1) = XFO_EXPORTACAO!titu_dt_Vencimento
            XGM_MATRIZLOG(7, 1) = XLT_DATADESCONTO
                        
            Call subRegistraLog("TelaExpBancaria", "1", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_SANTANDER))
            '*******************************************************************
  ...
  XLT_TEXTO = "9" & _
              Format(XLI_QUANTIDADEDOCUMENTOS, "000000") & _
              Format(Replace(XLF_VALORTOTAL, ",", ""), "0000000000000") & _
              Replace(Space(374), " ", "0") & _
              Format(XLI_NUMSQUENCIAL, "000000")
  Print #1, funTiraAcento(XLT_TEXTO, True)
  '*******************************
  Close #1
...
Private Sub CmdPesquisar_Click()
  ...
  If FunObrigatorioCBO(cboContaCorrenteMovimento, "Selecione uma Conta Corrente.") Then Exit Sub
  
  If Me.CboTipoCobranca.ListIndex = -1 Then
    MsgBox "Escolha o tipo de cobrança.", vbCritical, "ExpSantander"
    Exit Sub
  End If
  ...
  XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
     " coco_cd_codigo = " & cboContaCorrenteMovimento.BoundText
  XGT_CONJUNCAO = " AND "
  ...
  XFT_SQL = "SELECT *, " & _
   ...
   subCarregaVetor XFT_SQL, Array("Titulo", "Exporta", "titu_dt_Vencimento", "ValorReal", _
     ...
     "Seguro", "SaldoDevedor", "titu_nr_contratobanco"), VFV_VETOREXP, TDBGrid1
  ...
  SubQOpenRecordset XFO_EXPORTACAO, XFT_SQL2 & " ORDER BY Titulo", Estatico
...
Private Sub Form_Load()
    ...
    subConectarControleDadosNV DatContaCorrenteMovimento, "SELECT * FROM ConsGENCCcombo where empr_cd_empresa=" & Int(PCodEmpresa) & " AND (banc_cd_codigo=353 OR banc_cd_codigo=033) ORDER BY coco_tx_Descricao", Estatico
    subConectarControleDadosNV DatContaCorrenteCobranca, "SELECT * FROM ConsGENCCcombo where empr_cd_empresa=" & Int(PCodEmpresa) & " AND (banc_cd_codigo=353 OR banc_cd_codigo=033) ORDER BY coco_tx_Descricao", Estatico
...
Private Sub cboContaCorrenteMovimento_Change()
  
  If cboContaCorrenteMovimento.BoundText <> "" Then
    DatContaCorrenteMovimento.Recordset.Bookmark = cboContaCorrenteMovimento.SelectedItem
    TxtMensagem1.Text = FunNulo(DatContaCorrenteMovimento.Recordset.Fields("coco_tx_Mensagem1"))
    TxtMensagem2.Text = FunNulo(DatContaCorrenteMovimento.Recordset.Fields("coco_tx_Mensagem2"))
  End If
