...
Begin VB.Form FrmRelResumoGeral 
   Caption         =   "Relatório Resumo Geral dos Empreendimentos"
   ClientHeight    =   4890
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9345
   Icon            =   "FrmRelResumoGeral.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   4890
   ScaleWidth      =   9345
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraIndexador 
         Caption         =   "Indexador para Atualizar o Liquidado"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Begin MSDataListLib.DataCombo CboIndexador 
            Bindings        =   "FrmRelResumoGeral.frx":2AFA
            Height          =   315
            Left            =   1200
            TabIndex        =   50
            Top             =   240
         ...
         Begin Threed.SSCommand CmdLimparIndexador 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelResumoGeral.frx":2B15
            Picture         =   "FrmRelResumoGeral.frx":2F67
         End
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelResumoGeral.frx":3079
            Picture         =   "FrmRelResumoGeral.frx":3095
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelResumoGeral.frx":31A7
            Height          =   315
            Left            =   1740
            TabIndex        =   14
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelResumoGeral.frx":31C2
            Left            =   1740
            List            =   "FrmRelResumoGeral.frx":31D8
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelResumoGeral.frx":3213
            Picture         =   "FrmRelResumoGeral.frx":322F
         End
      ...
      Begin VB.Frame FraTitulosPagos 
         ...
         Begin VB.CheckBox ChkTitulosPagos 
            Alignment       =   1  'Right Justify
            Caption         =   "Considerar Títulos Pagos Após a Data Base?"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelResumoGeral.frx":3341
      Height          =   315
      Left            =   1320
      TabIndex        =   24
      Top             =   4440
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelResumoGeral.frx":3356
      Picture         =   "FrmRelResumoGeral.frx":37A8
   End
   ...
   End
End
Attribute VB_Name = "FrmRelResumoGeral"
...
Private Sub CmdImprimir_Click()
    ...
    Dim XLT_FILTROTITULOSPAGOS As String 'Titulos pagos com acrescimos
    ...
    Dim XLT_INDEXADORATUALIZADO As String
    
    FrmRelResumoGeral.MousePointer = vbHourglass
...
'    End If
    ...
    'IndexadorAtualizado
    If CboIndexador.BoundText <> "" Then
      XLT_INDEXADORATUALIZADO = CboIndexador.Text
    Else
      XLT_INDEXADORATUALIZADO = "@#$%@#$%"
    End If
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelResumoGeral.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    FrmVisRelatorios.Caption = "Relatório Resumo Geral Dos Empreendimentos"
    
    'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelResumoGeral.rpt")
    Set XGR_RELATORIO = Nothing
    Set XGR_RELATORIO = RptResumoGeral
...
Private Sub Form_Activate()
  Set Formulario = FrmRelResumoGeral
End Sub

Private Sub Form_Load()
  
  subManutencaoJanelasAtivas "I", "FrmRelResumoGeral"
