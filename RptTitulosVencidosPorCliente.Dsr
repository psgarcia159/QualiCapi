VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptTitulosVencidosPorCliente 
   ClientHeight    =   9630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11460
   OleObjectBlob   =   "RptTitulosVencidosPorCliente.dsx":0000
End
Attribute VB_Name = "RptTitulosVencidosPorCliente"
...
Private Sub Report_Initialize()
  ...
  AddReportVariable crRVNumber, "SOMAVALORORIGINAL2"
  AddReportVariable crRVNumber, "SOMAJUROS2"
  AddReportVariable crRVNumber, "SOMAMULTA2"
  AddReportVariable crRVNumber, "SOMAVALORPREVISTO2"
  
  AddReportVariable crRVNumber, "TOTALVALORORIGINAL"
  AddReportVariable crRVNumber, "TOTALJUROS"
  AddReportVariable crRVNumber, "TOTALMULTA"
...
Private Sub SecFooterCliente1_Format(ByVal pFormattingInfo As Object)
  ...
  '------------------------------- Somatorio ----------------------------------------
  SetReportVariableValue "SOMAVALORORIGINAL2", (FunNuloVal(GetReportVariableValue("SOMAVALORORIGINAL2")) + GetReportVariableValue("SOMAVALORORIGINAL"))
  SetReportVariableValue "SOMAJUROS2", (FunNuloVal(GetReportVariableValue("SOMAJUROS2")) + GetReportVariableValue("SOMAJUROS"))
  SetReportVariableValue "SOMAMULTA2", (FunNuloVal(GetReportVariableValue("SOMAMULTA2")) + GetReportVariableValue("SOMAMULTA"))
  SetReportVariableValue "SOMAVALORPREVISTO2", (FunNuloVal(GetReportVariableValue("SOMAVALORPREVISTO2")) + GetReportVariableValue("SOMAVALORPREVISTO"))
...
Private Sub SecFooterEmpreendimento1_Format(ByVal pFormattingInfo As Object)
  ...
  TxtSomaValorOriginal2.SetText Format(GetReportVariableValue("SOMAVALORORIGINAL2"), "standard")
  TxtSomaJuros2.SetText Format(GetReportVariableValue("SOMAJUROS2"), "standard")
  TxtSomaMulta2.SetText Format(GetReportVariableValue("SOMAMULTA2"), "standard")
  TxtSomaTotal2.SetText Format(GetReportVariableValue("SOMAVALORPREVISTO2"), "standard")
  
  '------------------------------- Somatorio ----------------------------------------
  SetReportVariableValue "TOTALVALORORIGINAL", (FunNuloVal(GetReportVariableValue("TOTALVALORORIGINAL")) + GetReportVariableValue("SOMAVALORORIGINAL2"))
  SetReportVariableValue "TOTALJUROS", (FunNuloVal(GetReportVariableValue("TOTALJUROS")) + GetReportVariableValue("SOMAJUROS2"))
  SetReportVariableValue "TOTALMULTA", (FunNuloVal(GetReportVariableValue("TOTALMULTA")) + GetReportVariableValue("SOMAMULTA2"))
  SetReportVariableValue "TOTALVALORPREVISTO", (FunNuloVal(GetReportVariableValue("TOTALVALORPREVISTO")) + GetReportVariableValue("SOMAVALORPREVISTO2"))
  
  SetReportVariableValue "SOMAVALORORIGINAL2", 0
  SetReportVariableValue "SOMAVALORPREVISTO2", 0
  SetReportVariableValue "SOMAJUROS2", 0
  SetReportVariableValue "SOMAMULTA2", 0
...
Private Sub SecFooterReport_Format(ByVal pFormattingInfo As Object)
  ...
  TxtTotalJuros.SetText Format(GetReportVariableValue("TOTALJUROS"), "standard")
  TxtTotalMulta.SetText Format(GetReportVariableValue("TOTALMULTA"), "standard")
  TxtTotalTotal.SetText Format(GetReportVariableValue("TOTALVALORPREVISTO"), "standard")
