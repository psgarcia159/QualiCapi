...
Begin VB.Form FrmRelPrevisaoRecebimento 
   Caption         =   "Relatório Previsão de Recebimento"
   ClientHeight    =   5160
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9330
   Icon            =   "FrmRelPrevisaoRecebimento.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   5160
   ScaleWidth      =   9330
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame frmTipoImovel 
         ...
         Begin MSDataListLib.DataCombo CboTipoImovel 
            Bindings        =   "FrmRelPrevisaoRecebimento.frx":2AFA
            Height          =   315
            Left            =   1740
            TabIndex        =   50
            Top             =   120
         ...
         Begin Threed.SSCommand CmdLimpaTipoImovel 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelPrevisaoRecebimento.frx":2B16
            Picture         =   "FrmRelPrevisaoRecebimento.frx":2B32
         End
      ...
      Begin VB.Frame FraAtraso 
         ...
         Begin VB.Label LblMultaJuros 
            Caption         =   "Apresentar títulos vencido com"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelPrevisaoRecebimento.frx":2C44
            Picture         =   "FrmRelPrevisaoRecebimento.frx":2C60
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelPrevisaoRecebimento.frx":2D72
            Height          =   315
            Left            =   1740
            TabIndex        =   11
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelPrevisaoRecebimento.frx":2D8D
            Left            =   1740
            List            =   "FrmRelPrevisaoRecebimento.frx":2DA3
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelPrevisaoRecebimento.frx":2DDE
            Picture         =   "FrmRelPrevisaoRecebimento.frx":2DFA
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame fraEmpresa 
         ...
         Top             =   120
         Width           =   4455
         Begin VB.CheckBox chkConsolidarEmpresas 
            Height          =   255
            Left            =   2040
            TabIndex        =   47
            Top             =   240
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelPrevisaoRecebimento.frx":2F0C
      Height          =   315
      Left            =   1260
      TabIndex        =   17
      Top             =   4740
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelPrevisaoRecebimento.frx":2F21
      Picture         =   "FrmRelPrevisaoRecebimento.frx":3373
   End
   ...
   End
End
Attribute VB_Name = "FrmRelPrevisaoRecebimento"
...
Private Sub chkConsolidarEmpresas_Click()

    If chkConsolidarEmpresas.Value = 1 Then
 
       
        MskImovelInicial.Enabled = False
        
        
        MskImovelFinal.Enabled = False
        
        CboTiposPlanos.BoundText = 0
        CboTiposPlanos.Text = ""
    ...
    Else
        ...
        MskImovelInicial.Enabled = True
     
        MskImovelFinal.Enabled = True
        
        CboTiposPlanos.Enabled = True
        
        CboNaturezasPlanos.Enabled = True
...
Private Sub CmdImprimir_Click()
  ...
  Dim XLO_TOTALINDEXADOR As New adodb.Recordset
 ...
 ' XGT_SELECAO = "SELECT * FROM ConsCAPRelPrevisaoRecebimento WHERE "
  
  'Consolidar Empresa
  
'  If (chkConsolidarEmpresas.Value = 1) Then
       'Filtra a empresa Ativa
  '      XGT_SELECAO = XGT_SELECAO + "ConsCAPRelPrevisaoRecebimento.empr_cd_empresa = " & CStr(PCodEmpresa)
  '  Else
 '       XGT_SELECAO = XGT_SELECAO + "ORDER BY ConsFINRelFinanceiros.empr_cd_empresa"
'    End If
  ...
  Else
    If ChkAtivo.Value = 1 Then
      ...
      ElseIf ChkCedido.Value = 1 Then  'Ativo e Cediddo
        XGT_SELECAO = XGT_SELECAO & _
  ...
  If ChkEmpreendimentos.Value = 1 Then
    XLT_FILTROEMPREENDIMENTOS = "1"
  Else
    XLT_FILTROEMPREENDIMENTOS = "0"
  End If
  ...
  'Filtra a empresa Ativa
  If (chkConsolidarEmpresas.Value = 0) Then
 ...
 Else
    XGT_SELECAO = XGT_SELECAO + " ORDER BY ConsCAPRelPrevisaoRecebimento.empr_cd_empresa"
 End If
  ...
  If XGO_RSRELATORIO.EOF Then
      ...
      FrmRelPrevisaoRecebimento.MousePointer = vbDefault
      Exit Sub
  End If
  ...
  Select Case XOrigem
   ...
   Case "Analitico Diario"
     FrmVisRelatorios.Caption = "Relatório Previsão de Recebimento Analítico Diário"
     If ChkEmpreendimentos.Value = 1 Then
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebAnaliticoDiarioAgrupados.rpt")
       Set RptPrevisaoRecebimentoAnaliticoDiarioAgrupados = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoAnaliticoDiarioAgrupados
     Else
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebAnaliticoDiario.rpt")
       Set RptPrevisaoRecebimentoAnaliticoDiario = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoAnaliticoDiario
     End If
    
   Case "Analitico Mensal"
     FrmVisRelatorios.Caption = "Relatório Previsão de Recebimento Analítico Mensal"
     If ChkEmpreendimentos.Value = 1 Then
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebAnaliticoMensalAgrupados.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoAnaliticoMensalAgrupados
     Else
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebAnaliticoMensal.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoAnaliticoMensal
     End If
     
   Case "Sintetico Diario"
     FrmVisRelatorios.Caption = "Relatório Previsão de Recebimento Sintético Diário"
     If ChkEmpreendimentos.Value = 1 Then
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebSinteticoDiarioAgrupados.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoSinteticoDiarioAgrupados
     Else
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebSinteticoDiario.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoSinteticoDiario
     End If
    
   Case "Sintetico Mensal"
     FrmVisRelatorios.Caption = "Relatório Previsão de Recebimento Sintético Mensal"
     If ChkEmpreendimentos.Value = 1 Then
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebSinteticoMensalAgrupados.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoSinteticoMensalAgrupados
     Else
       'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelPrevisaoRecebSinteticoMensal.rpt")
       Set XGR_RELATORIO = Nothing
       Set XGR_RELATORIO = RptPrevisaoRecebimentoSinteticoMensal
     End If
  End Select
  ...
  If XOrigem = "Analitico Mensal" Then
    If ChkEmpreendimentos.Value = 1 Then
      FrmVisRelatorios.SubAlterarDataSource_Subrelatorios XGR_RELATORIO, XGO_RSRELATORIO, "TotalIndexadorEmpreendimentosAgrupados"
    Else
...
Private Sub Form_Activate()
  Set Formulario = FrmRelPrevisaoRecebimento
End Sub

Private Sub Form_Load()
  
  subManutencaoJanelasAtivas "I", "FrmRelPrevisaoRecebimento"
  ...
  Select Case XOrigem
    Case "Analitico Diario"
      Me.Caption = "Relatório Previsão de Recebimento Analítico Diário"
    Case "Analitico Mensal"
      Me.Caption = "Relatório Previsão de Recebimento Analítico Mensal"
    Case "Sintetico Diario"
