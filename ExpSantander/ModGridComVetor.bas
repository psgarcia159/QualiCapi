        ...
        For XLI_X = 0 To VLV_VETOR.UpperBound(1)
            ...
            For XLI_Y = 0 To UBound(VLV_CHAVES, 1)
                ...
                ElseIf VLV_TIPOS(VLV_CHAVES(XLI_Y)) = "T" Then
                    XLS_CONDICAO = XLS_CONDICAO & XLS_CONJUNCAO & _
                      VLV_CAMPOSTABELA(VLV_CHAVES(XLI_Y)) & " = '" & CStr(XLS_VALORCHAVE) & "'"
                    XLS_CONJUNCAO = " AND "
            ...
            For XLI_Y = 0 To XLI_QTDCAMPOS - 1
                ...
                If VLV_TIPOS(XLI_Y) = "N" Then
                    XLS_VALORES = XLS_VALORES & Str(IIf(IsNumeric(XLV_VALORCAMPO), XLV_VALORCAMPO, 0))
                    XLS_ALTERACAO = XLS_ALTERACAO & VLV_CAMPOSTABELA(XLI_Y) & " = " & Str(IIf(IsNumeric(XLV_VALORCAMPO), XLV_VALORCAMPO, 0))
