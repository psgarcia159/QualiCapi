...
Begin VB.Form TelaManTabProfissoes 
   ...
   Begin Threed.SSPanel PanProfissao 
      Height          =   1515
      Left            =   1905
      TabIndex        =   11
      Top             =   690
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      Bindings        =   "TelaProfissoes.frx":0000
      Height          =   3690
      Left            =   45
      TabIndex        =   13
      Top             =   15
      ...
      Columns(0).DataField=   "prof_tx_descricao"
   ...
   Begin MSDataListLib.DataCombo cboLocalizar 
      Bindings        =   "TelaProfissoes.frx":0015
      Height          =   315
      Left            =   2760
      TabIndex        =   14
      Top             =   3750
   ...
   End
End
Attribute VB_Name = "TelaManTabProfissoes"
...
Private Sub CmdConfirmar_Click()
    ...
    Conexao.BeginTrans
    If PanProfissao.Tag = "I" Then
        XLT_SQL = "INSERT INTO Profissoes (prof_tx_descricao) VALUES ('" & TxtDescricao.Text & "')"
              Conexao.Execute XLT_SQL
    Else    'Alteração
        XLT_SQL = "UPDATE Profissoes SET prof_tx_descricao = '" & TxtDescricao.Text & "'" & _
                " WHERE prof_cd_profissao = " & PanProfissao.Tag
        Conexao.Execute XLT_SQL
    End If
    Conexao.CommitTrans
    ...
    If PanProfissao.Tag <> "I" Then
        cboLocalizar.BoundText = PanProfissao.Tag
        Adodc1.Recordset.bookmark = cboLocalizar.SelectedItem
    End If
...
Private Sub CmdImprimir_Click()
    Call subImprimeListagemGRID(1, TDBGrid1.PrintInfo, "Listagem de Profissões")
End Sub
...
Private Sub CmdRemoverFiltro_Click()
    ...
    Set Formulario = TelaManTabProfissoes
...
Private Sub CmdAlterar_Click()
    ...
    PanProfissao.Visible = True
    PanProfissao.Enabled = True
    PanProfissao.Left = (TDBGrid1.Width - PanProfissao.Width) / 2
    PanProfissao.Top = (TDBGrid1.Height - PanProfissao.Height) / 2
    PanProfissao.Tag = Adodc1.Recordset.Fields("prof_cd_profissao")
    PanProfissao.Caption = " Alteração de Profissão"
    subDesabilitaBotoes
    
    TxtDescricao.Text = Adodc1.Recordset.Fields("prof_tx_descricao")
...
Private Sub CmdExcluir_Click()
    ...
    If XLI_OPCAO = 1 Then  'Confirma exclusão
      ...
      Conexao.BeginTrans
      Conexao.Execute "DELETE FROM Profissoes WHERE prof_cd_profissao=" & Adodc1.Recordset.Fields("prof_cd_profissao")
      Conexao.CommitTrans
      subrecarregadadosNV Adodc1, "", FRM_Ordem, "", FRM_FiltroAtual
      Quantid = Quantid - 1
...
RotuloErro:
    ...
    If Err.Number = -2147467259 Then
      MsgBox "Essa profissão não pode ser excluída pois já possui algum cliente relacionado!", vbCritical, "ATENÇÃO"
...
Private Sub CmdInserir_Click()
    ...
    PanProfissao.Left = (TDBGrid1.Width - PanProfissao.Width) / 2
    PanProfissao.Top = (TDBGrid1.Height - PanProfissao.Height) / 2
    PanProfissao.Caption = " Inserção de Profissão"
    PanProfissao.Tag = "I"
    subDesabilitaBotoes
    TxtDescricao.Text = ""
    cboLocalizar.Text = ""
...
Private Sub Form_Load()
    ...
    subManutencaoJanelasAtivas "I", "TelaManTabProfissoes"
         
    'Associa um banco de dados à tabela profissões
    subCarregaDadosNV Adodc1, "Profissoes", "prof_tx_descricao", _
...
Private Sub Form_Unload(Cancel As Integer)
    subManutencaoJanelasAtivas "R", "TelaManTabProfissoes"
End Sub
