VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptFluxoGeralVencimento 
   ClientHeight    =   9630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12105
   OleObjectBlob   =   "RptFluxoGeralVencimento.dsx":0000
End
Attribute VB_Name = "RptFluxoGeralVencimento"
...
XFB_FOOTER = False
VFV_TOTALMOEDADEBITO.ReDim 0, 0, 0, 2
...
Private Sub SecDetalhe_Format(ByVal pFormattingInfo As Object)
  ...
  If XLO_CAMPOS.GetItemByName("titu_dt_Pagamento").Value = "" Then
    ...
    If XFT_TITULOANTERIOR <> XLO_CAMPOS.GetItemByName("Titulo").Value Then
      SubSomaMoeda XLI_MOEDA, XLT_MOEDA, VFV_TOTALMOEDADEBITO, XLF_VALORTITULO
    End If
...
Private Sub SecFooterPagamento3_Format(ByVal pFormattingInfo As Object)
  ...
  TxtTotalDebitoAualizado.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALDEBITOATUALIZADO")), "standard"))
  TxtTotalLiquidadoAtualizado.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALLIQUIDADOATUALIZADO")), "standard"))
