VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptTitulosVencidosPorClienteAgrupados 
   ClientHeight    =   9630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11460
   OleObjectBlob   =   "RptTitulosVencidosPorClienteAgrupados.dsx":0000
End
Attribute VB_Name = "RptTitulosVencidosPorClienteAgrupados"
...
Private Sub SecFooterCliente1_Format(ByVal pFormattingInfo As Object)
  ...
  SetReportVariableValue "TOTALJUROS", (FunNuloVal(GetReportVariableValue("TOTALJUROS")) + GetReportVariableValue("SOMAJUROS"))
  SetReportVariableValue "TOTALMULTA", (FunNuloVal(GetReportVariableValue("TOTALMULTA")) + GetReportVariableValue("SOMAMULTA"))
