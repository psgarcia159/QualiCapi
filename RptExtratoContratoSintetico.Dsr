VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptExtratoContratoSintetico 
   ClientHeight    =   14280
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   19095
   OleObjectBlob   =   "RptExtratoContratoSintetico.dsx":0000
End
Attribute VB_Name = "RptExtratoContratoSintetico"
...
Private Sub Report_Initialize()
  ...
  AddReportVariable crRVNumber, "SOMAVALORIMOVEL"
  ...
  AddReportVariable crRVNumber, "TOTALVALORIMOVEL"
...
Private Sub SectHeaderReport_Format(ByVal pFormattingInfo As Object)
  ...
  SetReportVariableValue "SOMAVALORIMOVEL", 0
  ...
  SetReportVariableValue "TOTALVALORIMOVEL", 0
...
Private Sub SecDetalhe_Format(ByVal pFormattingInfo As Object)
  ...
  'If XLO_CAMPOS.GetItemByName("FiltroTitulosPagos").Value = "N" Then
 ...
 SetReportVariableValue "SOMAVALORIMOVEL", CDbl(FunNuloVal(GetReportVariableValue("SOMALIQUIDADOATUALIZADO"))) + CDbl(FunNuloVal(GetReportVariableValue("SOMATOTAL12")))
...
Private Sub SecFooterCliente1_Format(ByVal pFormattingInfo As Object)
  ...
  SetReportVariableValue "TOTALVENCIDO", (FunNuloVal(GetReportVariableValue("TOTALVENCIDO")) + CDbl(FunNuloVal(GetReportVariableValue("SOMAVENCIDO"))))
  SetReportVariableValue "TOTALVENCERCOMAGIO", (FunNuloVal(GetReportVariableValue("TOTALVENCERCOMAGIO")) + CDbl(FunNuloVal(GetReportVariableValue("SOMAVENCERCOMAGIO"))))
  SetReportVariableValue "TOTALVENCERSEMAGIO", (FunNuloVal(GetReportVariableValue("TOTALVENCERSEMAGIO")) + CDbl(FunNuloVal(GetReportVariableValue("SOMAVENCERSEMAGIO"))))
  SetReportVariableValue "TOTALTOTAL12", (FunNuloVal(GetReportVariableValue("TOTALTOTAL12")) + CDbl(FunNuloVal(GetReportVariableValue("SOMATOTAL12"))))
  SetReportVariableValue "TOTALTOTAL13", (FunNuloVal(GetReportVariableValue("TOTALTOTAL13")) + CDbl(FunNuloVal(GetReportVariableValue("SOMATOTAL13"))))
  
  SetReportVariableValue "TOTALLIQUIDADOHISTORICO", (FunNuloVal(GetReportVariableValue("TOTALLIQUIDADOHISTORICO")) + GetReportVariableValue("SOMALIQUIDADOHISTORICO"))
  SetReportVariableValue "TOTALLIQUIDADOATUALIZADO", (FunNuloVal(GetReportVariableValue("TOTALLIQUIDADOATUALIZADO")) + GetReportVariableValue("SOMALIQUIDADOATUALIZADO"))
  
  SetReportVariableValue "TOTALVALORIMOVEL", (FunNuloVal(GetReportVariableValue("TOTALVALORIMOVEL")) + CDbl(FunNuloVal(GetReportVariableValue("SOMAVALORIMOVEL"))))
  ...
  TxtValorImovel.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("SOMAVALORIMOVEL")), "standard"))
...
Private Sub SecFooterEmpreendimento1_Format(ByVal pFormattingInfo As Object)
  ...
  TxtSomaVencido.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALVENCIDO")), "standard"))
  TxtSomaVencerComAgio.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALVENCERCOMAGIO")), "standard"))
  TxtSomaVencerSemAgio.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALVENCERSEMAGIO")), "standard"))
  TxtSomaTotal12.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALTOTAL12")), "standard"))
  TxtSomaTotal13.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALTOTAL13")), "standard"))
  TxtSomaLiquidadoHistorico.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALLIQUIDADOHISTORICO")), "standard"))
  TxtSomaLiquidadoAtualizado.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALLIQUIDADOATUALIZADO")), "standard"))
  
  TxtSomaValorImovel.SetText FunTrataZero(Format(FunNuloVal(GetReportVariableValue("TOTALVALORIMOVEL")), "standard"))
