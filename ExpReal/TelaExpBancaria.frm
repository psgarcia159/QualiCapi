...
Begin VB.Form TelaExpBancaria 
   Caption         =   "Exportação Bancária - REAL"
   ClientHeight    =   5730
   ClientLeft      =   75
   ClientTop       =   1470
   ClientWidth     =   9360
   ...
   Begin Threed.SSPanel PanPesquisa 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(0)=   "LblCCorrente"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).Control(1)=   "LblNaturezaPlano"
         Tab(0).Control(1).Enabled=   0   'False
         Tab(0).Control(2)=   "LblTipoPlano"
         Tab(0).Control(2).Enabled=   0   'False
         Tab(0).Control(3)=   "LblDtExportacao"
         Tab(0).Control(3).Enabled=   0   'False
         Tab(0).Control(4)=   "LblMesAno"
         Tab(0).Control(4).Enabled=   0   'False
         Tab(0).Control(5)=   "DatObs"
         Tab(0).Control(5).Enabled=   0   'False
         Tab(0).Control(6)=   "DatTipoPlano"
         Tab(0).Control(6).Enabled=   0   'False
         Tab(0).Control(7)=   "DatContaCorrente"
         Tab(0).Control(7).Enabled=   0   'False
         Tab(0).Control(8)=   "CboCCorrente"
         Tab(0).Control(8).Enabled=   0   'False
         Tab(0).Control(9)=   "CmdLimparNaturezaPlano"
         Tab(0).Control(9).Enabled=   0   'False
         Tab(0).Control(10)=   "CboTiposPlanos"
         Tab(0).Control(10).Enabled=   0   'False
         Tab(0).Control(11)=   "CmdLimparTipoPlano"
         Tab(0).Control(11).Enabled=   0   'False
         Tab(0).Control(12)=   "DtpExportacao"
         Tab(0).Control(12).Enabled=   0   'False
         Tab(0).Control(13)=   "DtpVencimento"
         Tab(0).Control(13).Enabled=   0   'False
         Tab(0).Control(14)=   "CboNaturezasPlanos"
         ...
         TabCaption(4)   =   "Mensagens"
         TabPicture(4)   =   "TelaExpBancaria.frx":093A
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "LblMensagem1"
         Tab(4).Control(1)=   "LblMensagem2"
         Tab(4).Control(2)=   "LblMensagem3"
         Tab(4).Control(3)=   "LblMensagem4"
         Tab(4).Control(4)=   "LblMensagem5"
         Tab(4).Control(5)=   "TxtMensagem4"
         Tab(4).Control(6)=   "TxtMensagem3"
         Tab(4).Control(7)=   "TxtMensagem2"
         Tab(4).Control(8)=   "TxtMensagem1"
         Tab(4).Control(9)=   "TxtMensagem5"
         Tab(4).ControlCount=   10
         Begin VB.TextBox TxtMensagem5 
            Height          =   315
            Left            =   -73080
            MaxLength       =   69
            TabIndex        =   70
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "TelaExpBancaria.frx":0956
            Left            =   1965
            List            =   "TelaExpBancaria.frx":096C
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "TelaExpBancaria.frx":09A7
            Picture         =   "TelaExpBancaria.frx":09C3
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "TelaExpBancaria.frx":0AD5
            Height          =   315
            Left            =   1965
            TabIndex        =   33
            Top             =   1380
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "TelaExpBancaria.frx":0AF0
            Picture         =   "TelaExpBancaria.frx":0B0C
         End
         Begin MSDataListLib.DataCombo CboCCorrente 
            Bindings        =   "TelaExpBancaria.frx":0C1E
            Height          =   330
            Left            =   1965
            TabIndex        =   35
            Top             =   2190
...
Private Sub CmdExportar_Click()
  ...
  Dim XLT_CODMENSAGEM1 As String
  Dim XLT_CODMENSAGEM2 As String
  Dim XLT_CODMENSAGEM3 As String
  Dim XLT_CODMENSAGEM4 As String
  Dim XLT_CODMENSAGEM5 As String
  
  Dim XLT_DATADESCONTO As String
  Dim XLF_DESCONTO As Double
  Dim XLI_NUMSQUENCIAL As Integer
  Dim XLB_VAZIO As Boolean
  Dim XLF_VALTOTAL As Double
  Dim XLI_QTDTITULO As Integer
  
  Dim XLT_CODMOEDA As String
  
  Dim XLT_CONVENIO As String 'Código do contrato no banco
  Dim XLT_CARTEIRA As String 'Código da carteira de cobrança
  ...
  DlgSalvar.DialogTitle = "Arquivo de Exportação do Real"
  ...
  If IsNumeric(DatContaCorrente.Recordset.Fields!coco_nr_ConvenioCobranca) Then
    XLT_CONVENIO = Format(DatContaCorrente.Recordset.Fields!coco_nr_ConvenioCobranca, "000000000")
  Else
    XLT_CONVENIO = "000000000"
  End If
  
  If IsNumeric(DatContaCorrente.Recordset.Fields!coco_nr_CarteiraCobranca) Then
    XLT_CARTEIRA = Format(DatContaCorrente.Recordset.Fields!coco_nr_CarteiraCobranca, "000")
  Else
    XLT_CARTEIRA = "   "
  End If
  ...
  While Not TDBGrid1.EOF
      If TDBGrid1.Columns("Exp.").Value = "-1" Then
          ...
          'Armazena o valor total dos títulos
          XLF_VALTOTAL = XLF_VALTOTAL + XLF_VALOR
          ...
          If XFO_EXPORTACAO!focl_tx_Tipo = "F" Then
            XLT_TIPO = "01"
            XLT_CGCCPF = Mid(XFO_EXPORTACAO!focl_tx_CGCCPF, 1, 3) + Mid(XFO_EXPORTACAO!focl_tx_CGCCPF, 5, 3) + Mid(XFO_EXPORTACAO!focl_tx_CGCCPF, 9, 3) + "000" + Mid(XFO_EXPORTACAO!focl_tx_CGCCPF, 13, 2)
          Else
            XLT_TIPO = "02"
          ...
          If XFO_EXPORTACAO!clie_tx_EndCorresp = "" And XFO_EXPORTACAO!clie_tx_BairroCorresp = "" _
            ...
            If TxtMensagem2.Text <> "" Then
                XLT_CODMENSAGEM2 = "3"
            End If
            
            If TxtMensagem3.Text <> "" Then
                XLT_CODMENSAGEM3 = "3"
            End If
            
            If TxtMensagem4.Text <> "" Then
                XLT_CODMENSAGEM4 = "3"
            End If
            
            If TxtMensagem5.Text <> "" Then
                XLT_CODMENSAGEM5 = "3"
            End If
            ...
            XLT_TEXTO = XLT_TEXTO & _
                       ...
                       XLT_CIDADE & _
                       XLT_ESTADO & _
                       Left(PEmpresa, 40) & Space(40 - Len(Left(PEmpresa, 40))) & _
                       "0" & _
                       "07" & _
              ...
              XLT_TEXTO = "8" & _
                          ...
                          Format(Left(DatContaCorrente.Recordset.Fields!coco_tx_Conta, 7), "0000000") & _
                          Left(XFO_EXPORTACAO!Titulo, 4) & Mid(XFO_EXPORTACAO!Titulo, 6, 4) & Mid(XFO_EXPORTACAO!Titulo, 11, 2) & _
                          TxtMensagem1 & Space(69 - Len(TxtMensagem1.Text)) & _
                          XLT_CODMENSAGEM1 & _
                          TxtMensagem2 & Space(69 - Len(TxtMensagem2.Text)) & _
                          XLT_CODMENSAGEM2 & _
                          TxtMensagem3 & Space(69 - Len(TxtMensagem3.Text)) & _
                          XLT_CODMENSAGEM3 & _
                          TxtMensagem4 & Space(69 - Len(TxtMensagem4.Text)) & _
                          XLT_CODMENSAGEM4 & _
                          TxtMensagem5 & Space(69 - Len(TxtMensagem5.Text)) & _
                          XLT_CODMENSAGEM5 & _
                          Space(19) & _
                          Format(XLI_NUMSQUENCIAL, "000000")
            ...
            XGM_MATRIZLOG(4, 0) = "Conta corrente"
            XGM_MATRIZLOG(5, 0) = "Data Vencimento"
            ...
            XGM_MATRIZLOG(4, 1) = DatContaCorrente.Recordset.Fields!coco_cd_Agencia & "-" & DatContaCorrente.Recordset.Fields!coco_tx_Conta
            XGM_MATRIZLOG(5, 1) = XFO_EXPORTACAO!titu_dt_Vencimento
            
            Call subRegistraLog("TelaExpBancaria", "1", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_REAL))
            '*******************************************************************
  ...
  '******TRAILER DE ARQUIVO*******
  XLT_TEXTO = "9" & _
              Format(XLI_QTDTITULO, "000000") & _
              Format(XLF_VALTOTAL * 100, "0000000000000") & _
              Space(374) & _
              Format(XLI_NUMSQUENCIAL, "000000")
...
Private Sub CmdPesquisar_Click()
  ...
  XFT_SQL2 = FunCriaConsultaBase(TDBGrid1.Columns("Vencimento"), NomeSgbd, "ConsCAPExpBanco", 1)
...
Private Sub Form_Load()
    ...
    subConectarControleDadosNV DatContaCorrente, "SELECT * FROM ConsGENCCcombo where empr_cd_empresa=" & Int(PCodEmpresa) & _
    "ORDER BY coco_tx_Descricao", Estatico
...
Private Sub CboCCorrente_Change()
  ...
  If CboCCorrente.BoundText <> "" Then
    ...
    TxtMensagem3.Text = FunNulo(DatContaCorrente.Recordset.Fields("coco_tx_Mensagem3"))
    TxtMensagem4.Text = FunNulo(DatContaCorrente.Recordset.Fields("coco_tx_Mensagem4"))
  End If
