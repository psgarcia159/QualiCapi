...
Begin VB.Form FrmRelDemonstrativoCliente 
   Caption         =   "Relatório Demonstrativo Por Empreendimento"
   ClientHeight    =   5280
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9360
   Icon            =   "FrmRelDemonstrativoPorCliente.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   5280
   ScaleWidth      =   9360
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraIndexador 
         ...
         Begin MSDataListLib.DataCombo CboIndexador 
            Bindings        =   "FrmRelDemonstrativoPorCliente.frx":2AFA
            Height          =   315
            Left            =   1140
            TabIndex        =   50
            Top             =   240
         ...
         Begin Threed.SSCommand CmdLimparIndexador 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelDemonstrativoPorCliente.frx":2B15
            Picture         =   "FrmRelDemonstrativoPorCliente.frx":2F67
         End
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelDemonstrativoPorCliente.frx":3079
            Left            =   1260
            List            =   "FrmRelDemonstrativoPorCliente.frx":308F
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelDemonstrativoPorCliente.frx":30CA
            Picture         =   "FrmRelDemonstrativoPorCliente.frx":30E6
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelDemonstrativoPorCliente.frx":31F8
            Height          =   315
            Left            =   1260
            TabIndex        =   39
            Top             =   180
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelDemonstrativoPorCliente.frx":3213
            Picture         =   "FrmRelDemonstrativoPorCliente.frx":322F
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelDemonstrativoPorCliente.frx":3341
      Height          =   315
      Left            =   1380
      TabIndex        =   15
      Top             =   4800
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelDemonstrativoPorCliente.frx":3356
      Picture         =   "FrmRelDemonstrativoPorCliente.frx":37A8
   End
   ...
   End
End
Attribute VB_Name = "FrmRelDemonstrativoCliente"
...
Private Sub CmdImprimir_Click()
    ...
    FrmRelDemonstrativoCliente.MousePointer = vbHourglass
...
'      " From ConsCAPRelExtratoContrato WHERE "
    ...
    ElseIf (IsNull(DtpInicio.Value)) And (Not IsNull(DtpFim.Value)) Then
        XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
        "(ConsCAPRelExtratoContrato.titu_dt_Vencimento <= '" & Format(DtpFim.Value, "mm/dd/yyyy") & "')"
        XGT_CONJUNCAO = " AND "
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelDemonstrativoCliente.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    FrmVisRelatorios.Caption = "Demonstrativo Por Empreendimento"
       
    'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelDemonstrativoPorEmpreendimento.rpt")
    Set RptDemonstrativoPorEmpreendimento = Nothing
    Set XGR_RELATORIO = RptDemonstrativoPorEmpreendimento
...
Private Sub Form_Activate()
  Set Formulario = FrmRelDemonstrativoCliente
End Sub

Private Sub Form_Load()
  
  subManutencaoJanelasAtivas "I", "FrmRelDemonstrativoCliente"
