...
Begin VB.Form FrmNotasFiscais 
   ...
   Begin TabDlg.SSTab TabNotasFiscais 
      ...
      TabPicture(0)   =   "FrmNotasFiscaisSemIdentificador.frx":0000
      ...
      TabPicture(1)   =   "FrmNotasFiscaisSemIdentificador.frx":001C
      ...
      TabPicture(2)   =   "FrmNotasFiscaisSemIdentificador.frx":0038
      ...
      TabPicture(3)   =   "FrmNotasFiscaisSemIdentificador.frx":0054
      ...
      Begin Threed.SSPanel PanDistribuicao 
         ...
         Begin MSDataListLib.DataCombo CboPlanoContas2 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0070
            Height          =   330
            Left            =   2745
            TabIndex        =   43
            Top             =   705
         ...
         Begin MSDataListLib.DataCombo CboPcr2 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0087
            Height          =   330
            Left            =   2745
            TabIndex        =   41
            Top             =   255
      ...
      Begin Threed.SSPanel PnlCompDuplicata 
         ...
         Begin Threed.SSPanel PanPagto2 
            ...
            Begin VB.ComboBox CboTipoPagto2 
               Height          =   315
               ItemData        =   "FrmNotasFiscaisSemIdentificador.frx":009C
               Left            =   1875
               List            =   "FrmNotasFiscaisSemIdentificador.frx":00B5
            ...
            Begin VB.ComboBox CboStatusduplicata 
               Height          =   315
               ItemData        =   "FrmNotasFiscaisSemIdentificador.frx":010F
               Left            =   6180
               List            =   "FrmNotasFiscaisSemIdentificador.frx":0119
               Style           =   2  'Dropdown List
               TabIndex        =   23
               Top             =   105
               Width           =   1935
            ...
            Begin MSDataListLib.DataCombo CboCCorrente2 
               Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0137
               Height          =   330
               Left            =   1860
               TabIndex        =   26
               Top             =   1050
         ...
         Begin MSDataListLib.DataCombo CboBancoForn2 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0156
            Height          =   330
            Left            =   1920
            TabIndex        =   27
            Top             =   1680
      ...
      Begin Threed.SSPanel PanNotasFiscais 
         ...
         Begin MSDataListLib.DataCombo CboFornecedor 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0177
            Height          =   315
            Left            =   1320
            TabIndex        =   2
            Top             =   195
         ...
         Begin MSDataListLib.DataCombo CboHistorico 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0193
            Height          =   315
            Left            =   1320
            TabIndex        =   8
            Top             =   1165
         ...
         Begin Threed.SSCommand CmdLimparHistorico 
            ...
            _StockProps     =   78
            Enabled         =   0   'False
            MouseIcon       =   "FrmNotasFiscaisSemIdentificador.frx":01AE
            Picture         =   "FrmNotasFiscaisSemIdentificador.frx":0600
         End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox CboStatus 
            Height          =   315
            ItemData        =   "FrmNotasFiscaisSemIdentificador.frx":0712
            Left            =   1320
            List            =   "FrmNotasFiscaisSemIdentificador.frx":071F
            Style           =   2  'Dropdown List
            TabIndex        =   0
            Top             =   160
            Width           =   2415
         ...
         Begin MSDataListLib.DataCombo CboTipoDoc 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0747
            Height          =   315
            Left            =   5400
            TabIndex        =   1
            Top             =   165
      ...
      Begin TabDlg.SSTab TabAuxiliar 
         ...
         TabPicture(0)   =   "FrmNotasFiscaisSemIdentificador.frx":0760
         Tab(0).ControlEnabled=   -1  'True
         ...
         TabPicture(1)   =   "FrmNotasFiscaisSemIdentificador.frx":077C
         Tab(1).ControlEnabled=   0   'False
         ...
         Begin Threed.SSPanel PanPagto1 
            ...
            Begin VB.ComboBox CboTipoPagto1 
               Height          =   315
               ItemData        =   "FrmNotasFiscaisSemIdentificador.frx":0798
               Left            =   1860
               List            =   "FrmNotasFiscaisSemIdentificador.frx":07B1
               Style           =   2  'Dropdown List
               TabIndex        =   14
               Top             =   367
               Width           =   2655
            ...
            Begin MSDataListLib.DataCombo CboCCorrente 
               Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":080B
               Height          =   330
               Left            =   1860
               TabIndex        =   16
               Top             =   705
         ...
         Begin MSDataListLib.DataCombo CboPlanoContas 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":082A
            Height          =   330
            Left            =   2880
            TabIndex        =   13
            Top             =   1170
         ...
         Begin MSDataListLib.DataCombo CboBancoForn1 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0841
            Height          =   330
            Left            =   -73080
            TabIndex        =   17
            Top             =   1430
         ...
         Begin MSDataListLib.DataCombo CboPcr 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0862
            Height          =   330
            Left            =   2880
            TabIndex        =   11
            Top             =   705
      ...
      Begin Threed.SSPanel pandescontos 
         ...
         Begin MSDataListLib.DataCombo CboDescontos 
            Bindings        =   "FrmNotasFiscaisSemIdentificador.frx":0877
            Height          =   315
            Left            =   1575
            TabIndex        =   35
            Top             =   240
