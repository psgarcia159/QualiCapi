...
Begin VB.Form FrmRelExtratoContratoAnalitico 
   Caption         =   "Relatório Extrato do Contrato - Analítico"
   ClientHeight    =   5190
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9360
   Icon            =   "FrmRelExtratoContratoAnalitico.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   ScaleHeight     =   5190
   ScaleWidth      =   9360
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraIndexador 
         ...
         Begin MSDataListLib.DataCombo CboIndexador 
            Bindings        =   "FrmRelExtratoContratoAnalitico.frx":2AFA
            Height          =   315
            Left            =   1140
            TabIndex        =   51
            Top             =   240
         ...
         Begin Threed.SSCommand CmdLimparIndexador 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnalitico.frx":2B15
            Picture         =   "FrmRelExtratoContratoAnalitico.frx":2F67
         End
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelExtratoContratoAnalitico.frx":3079
            Left            =   1260
            List            =   "FrmRelExtratoContratoAnalitico.frx":308F
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnalitico.frx":30CA
            Picture         =   "FrmRelExtratoContratoAnalitico.frx":30E6
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelExtratoContratoAnalitico.frx":31F8
            Height          =   315
            Left            =   1260
            TabIndex        =   13
            Top             =   180
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnalitico.frx":3213
            Picture         =   "FrmRelExtratoContratoAnalitico.frx":322F
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelExtratoContratoAnalitico.frx":3341
      Height          =   315
      Left            =   1380
      TabIndex        =   22
      Top             =   4800
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelExtratoContratoAnalitico.frx":3356
      Picture         =   "FrmRelExtratoContratoAnalitico.frx":37A8
   End
   ...
   End
End
Attribute VB_Name = "FrmRelExtratoContratoAnalitico"
...
'RELATÓRIO INTERNO É CASE SENSITIVE
   ...
   XLT_SQL = XLT_SQL & _
    ...
    Else
      ...
      Set RptExtratoContratoAnalitico = Nothing
      Set XGR_RELATORIO = RptExtratoContratoAnalitico
    End If
