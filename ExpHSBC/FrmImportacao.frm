...
Begin VB.Form FrmImportacao 
   ...
   Caption         =   "Retorno de Pagamento Eletrônico - HSBC"
   ClientHeight    =   1785
   ClientLeft      =   1980
   ClientTop       =   1500
   ClientWidth     =   9120
...
Private Sub CmdConfirmar_Click()
  ...
  DlgAbrirFigura.Filter = "Arquivo de Retorno do HSBC (*.txt)|*.txt"
  ...
  XLT_CODEMPRESA = Format(Left(DatContaCorrente.Recordset.Fields!coco_cd_Agencia, 4), "0000") & _
              "55" & _
              Format(Left(DatContaCorrente.Recordset.Fields!coco_cd_Agencia, 4), "0000") & Format(Left(DatContaCorrente.Recordset.Fields!coco_tx_Conta, 5), "00000") & Format(Right(FunNuloVal(DatContaCorrente.Recordset.Fields!coco_nr_Dac), 2), "00")
  ...
  While Not EOF(1)
    ...
    If Left(XLT_TEXTO, 1) = "1" Then
      ...
      If Mid(XLT_TEXTO, 19, 17) = XLT_CODEMPRESA Then
    
        If Mid(XLT_TEXTO, 109, 2) = "06" Or Mid(XLT_TEXTO, 109, 2) = "07" _
          Or Mid(XLT_TEXTO, 109, 2) = "31" Or Mid(XLT_TEXTO, 109, 2) = "33" Then
          ...
          If IsNull(XLO_IMPORTACAO!titu_dt_Pagamento) Then
            ...
            Call subRegistraLog("TelaExpBancaria", "2", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_HSBC))
            '*******************************************************************
