...
Begin VB.Form FrmRelExtratoContratoResumoDebitos 
   Caption         =   "Relatório Resumo dos Débitos por Contrato"
   ClientHeight    =   3720
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9345
   Icon            =   "FrmRelExtratoContratoResumoDebitos.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   3720
   ScaleWidth      =   9345
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoResumoDebitos.frx":2AFA
            Picture         =   "FrmRelExtratoContratoResumoDebitos.frx":2B16
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelExtratoContratoResumoDebitos.frx":2C28
            Height          =   315
            Left            =   1740
            TabIndex        =   11
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelExtratoContratoResumoDebitos.frx":2C43
            Left            =   1740
            List            =   "FrmRelExtratoContratoResumoDebitos.frx":2C59
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoResumoDebitos.frx":2C94
            Picture         =   "FrmRelExtratoContratoResumoDebitos.frx":2CB0
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelExtratoContratoResumoDebitos.frx":2DC2
      Height          =   315
      Left            =   1260
      TabIndex        =   18
      Top             =   3240
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelExtratoContratoResumoDebitos.frx":2DD7
      Picture         =   "FrmRelExtratoContratoResumoDebitos.frx":3229
   End
   ...
   End
End
Attribute VB_Name = "FrmRelExtratoContratoResumoDebitos"
...
Private Sub CmdImprimir_Click()
    ...
    FrmRelExtratoContratoResumoDebitos.MousePointer = vbHourglass
...
'      " From ConsCAPRelExtratoContrato WHERE "
    ...
    XGT_SELECAO = XGT_SELECAO + XGT_CONJUNCAO + "ConsCAPRelExtratoContrato.titu_dt_Pagamento is null"
    XGT_CONJUNCAO = " AND "
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelExtratoContratoResumoDebitos.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    FrmVisRelatorios.Caption = "Relatório Resumo dos Débitos Por Contrato"
    
    'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelExtratoContratoResumoDebitos.rpt")
    Set RptExtratoContratoResumoDebitos = Nothing
    Set XGR_RELATORIO = RptExtratoContratoResumoDebitos
...
Private Sub Form_Activate()
  Set Formulario = FrmRelExtratoContratoResumoDebitos
End Sub

Private Sub Form_Load()
  subManutencaoJanelasAtivas "I", "FrmRelExtratoContratoResumoDebitos"
