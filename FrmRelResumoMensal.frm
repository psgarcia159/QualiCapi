...
Begin VB.Form FrmRelResumoMensal 
   Caption         =   "Relatório Resumo Mensal dos Empreendimentos"
   ClientHeight    =   4050
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9345
   Icon            =   "FrmRelResumoMensal.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   4050
   ScaleWidth      =   9345
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelResumoMensal.frx":2AFA
            Picture         =   "FrmRelResumoMensal.frx":2B16
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelResumoMensal.frx":2C28
            Height          =   315
            Left            =   1740
            TabIndex        =   19
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelResumoMensal.frx":2C43
            Left            =   1740
            List            =   "FrmRelResumoMensal.frx":2C59
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelResumoMensal.frx":2C94
            Picture         =   "FrmRelResumoMensal.frx":2CB0
         End
      ...
      Begin VB.Frame FraAtraso 
         ...
         Begin VB.Label LblMultaJuros 
            Caption         =   "Apresentar títulos em atraso com"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Frame FraPagos 
         ...
         Top             =   1800
         Width           =   4575
         Begin VB.CheckBox ChkTitulosPagosAcrescimos 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FraPeriodo 
         Caption         =   "Período de Vencimento/Pagamento"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelResumoMensal.frx":2DC2
      Height          =   315
      Left            =   1320
      TabIndex        =   29
      Top             =   3600
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelResumoMensal.frx":2DD7
      Picture         =   "FrmRelResumoMensal.frx":3229
   End
   ...
   End
End
Attribute VB_Name = "FrmRelResumoMensal"
...
Private Sub CmdImprimir_Click()
    ...
    Dim XLT_CONSIDERARTITULOSPAGOS As String 'Considerar os títulos que forma pagos
    ...
    FrmRelResumoMensal.MousePointer = vbHourglass
...
'      " From ConsCAPRelExtratoContrato WHERE "
   ...
   'Período de Vencimento
    ...
    If (Not IsNull(DtpInicio.Value)) And (Not IsNull(DtpFim.Value)) Then
       XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
        "(titu_dt_Pagamento is null OR (ConsCAPRelExtratoContrato.titu_dt_Pagamento >= " & FunNuloData(DtpInicio.Value, NomeSgbd) & "" & _
        " AND ConsCAPRelExtratoContrato.titu_dt_Pagamento <= " & FunNuloData(DtpFim.Value, NomeSgbd) & "))"
        XGT_CONJUNCAO = " AND "
        XLT_FILTROPERIODOPAGAMENTO = "Pagamento: " & Format$(DtpInicio.Value, "dd/mm/yy") & " a " & Format$(DtpFim.Value, "dd/mm/yy")
    ElseIf (Not IsNull(DtpInicio.Value)) And (IsNull(DtpFim.Value)) Then
        XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
        "(titu_dt_Pagamento is null OR ConsCAPRelExtratoContrato.titu_dt_Pagamento >= " & FunNuloData(DtpInicio.Value, NomeSgbd) & ")"
        XGT_CONJUNCAO = " AND "
        XLT_FILTROPERIODOPAGAMENTO = "Pagamento: A partir de " & Format$(DtpInicio.Value, "dd/mm/yy")
    ElseIf (IsNull(DtpInicio.Value)) And (Not IsNull(DtpFim.Value)) Then
        XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
        "(titu_dt_Pagamento is null OR ConsCAPRelExtratoContrato.titu_dt_Pagamento <= " & FunNuloData(DtpFim.Value, NomeSgbd) & ")"
        XGT_CONJUNCAO = " AND "
        XLT_FILTROPERIODOPAGAMENTO = "Pagamento: Até " & Format$(DtpFim.Value, "dd/mm/yy")
    Else
    ...
    If ChkTitulosPagos.Value = 1 Then
      ...
      XGT_CONJUNCAO = " AND "
      XLT_CONSIDERARTITULOSPAGOS = "1"
    Else
      'XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
      '"ConsCAPRelExtratoContrato.titu_dt_Pagamento is Null"
      XGT_CONJUNCAO = " AND "
      XLT_CONSIDERARTITULOSPAGOS = "0"
    End If
    ...
    'Titulos pagos com acréscimos
    If ChkTitulosPagosAcrescimos.Value = 1 Then
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelResumoMensal.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    FrmVisRelatorios.Caption = "Relatório Resumo Mensal Dos Empreendimentos"
    
    If ChkEmpreendimentos.Value = 1 Then
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelResumoMensalAgrupados.rpt")
      Set XGR_RELATORIO = Nothing
      Set XGR_RELATORIO = RptResumoMensalAgrupados
    Else
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelResumoMensal.rpt")
      Set XGR_RELATORIO = Nothing
      Set XGR_RELATORIO = RptResumoMensal
    End If
    ...
    With XGR_RELATORIO.FormulaFields
        ...
        .GetItemByName("ConsiderarTitulosPagos").Text = Chr(34) & XLT_CONSIDERARTITULOSPAGOS & Chr(34)
...
Private Sub Form_Activate()
  Set Formulario = FrmRelResumoMensal
End Sub

Private Sub Form_Load()
  subManutencaoJanelasAtivas "I", "FrmRelResumoMensal"
