...
Begin VB.Form FrmRelTitulosVencidosPorCliente 
   Caption         =   "Relatório Títulos Vencidos Por Cliente"
   ClientHeight    =   4035
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9360
   Icon            =   "FrmRelTitulosVencidosPorCliente.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   4035
   ScaleWidth      =   9360
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelTitulosVencidosPorCliente.frx":2AFA
            Picture         =   "FrmRelTitulosVencidosPorCliente.frx":2B16
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelTitulosVencidosPorCliente.frx":2C28
            Height          =   315
            Left            =   1740
            TabIndex        =   11
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelTitulosVencidosPorCliente.frx":2C43
            Left            =   1740
            List            =   "FrmRelTitulosVencidosPorCliente.frx":2C59
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelTitulosVencidosPorCliente.frx":2C94
            Picture         =   "FrmRelTitulosVencidosPorCliente.frx":2CB0
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelTitulosVencidosPorCliente.frx":2DC2
      Height          =   315
      Left            =   1260
      TabIndex        =   18
      Top             =   3600
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelTitulosVencidosPorCliente.frx":2DD7
      Picture         =   "FrmRelTitulosVencidosPorCliente.frx":3229
   End
   ...
   End
End
Attribute VB_Name = "FrmRelTitulosVencidosPorCliente"
...
Private Sub CmdImprimir_Click()
    ...
    FrmRelTitulosVencidosPorCliente.MousePointer = vbHourglass
...
'      " From ConsCAPRelPrevisaoRecebimentoPorCliente WHERE "
    ...
    If ChkProrrogados.Value = 1 Then
      ...
      'Período de Prorrogacao
       ...
       ElseIf (IsNull(DtpInicio.Value)) And (Not IsNull(DtpFim.Value)) Then
           XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
           "(ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Vencimento <= " & FunNuloData(DtpFim.Value, NomeSgbd) & ")"
           XGT_CONJUNCAO = " AND "
    ...
    Else
      If ChkAtivo.Value = 1 Then
        XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
          "(ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Venda <= " & FunNuloData(DtpDtBase.Value, NomeSgbd) & _
          " AND (ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato is null OR " & _
          " (ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato > " & FunNuloData(DtpDtBase.Value, NomeSgbd) & " AND " & _
          " ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status<>'C')) "
        
        If ChkInativo.Value = 1 Then  'Ativo e Inativo
          XGT_SELECAO = XGT_SELECAO & _
            " OR (ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status = 'I'" & _
            " AND ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato<=" & FunNuloData(DtpDtBase.Value, NomeSgbd) & "))"
        ...
        ElseIf ChkCedido.Value = 1 Then  'Ativo e Cedido
          XGT_SELECAO = XGT_SELECAO & _
            " OR (ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status = 'C'" & _
            " AND ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato<=" & FunNuloData(DtpDtBase.Value, NomeSgbd) & "))"
    ...
    XGT_CONJUNCAO = " AND "
      ...
      ElseIf ChkInativo.Value = 1 Then
        If ChkCedido.Value = 1 Then   'Inativo e Cedido
          XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
            " ((ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status = 'I'" & _
            " OR ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status = 'C')" & _
            " AND ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato<=" & FunNuloData(DtpDtBase.Value, NomeSgbd) & ")"
      ...
      ElseIf ChkCedido.Value = 1 Then 'Cedido
         XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
           " (ConsCAPRelPrevisaoRecebimentoPorCliente.cont_tx_Status = 'C'" & _
           " AND ConsCAPRelPrevisaoRecebimentoPorCliente.cont_dt_Distrato<=" & FunNuloData(DtpDtBase.Value, NomeSgbd) & ")"
    ...
    If ChkTitulosPagos.Value = 1 Then
      ...
      " ConsCAPRelPrevisaoRecebimentoPorCliente.tipl_tx_Sigla <> 'R')"
      
      XGT_SELECAO = XGT_SELECAO & _
      " OR(ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Pagamento is Null AND " & _
      " ConsCAPRelPrevisaoRecebimentoPorCliente.tipl_tx_Sigla = 'R' AND " & _
      " ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Base < " & FunNuloData(DtpDtBase.Value, NomeSgbd) & ") "
      
      XGT_SELECAO = XGT_SELECAO & _
      " OR (ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Pagamento is not Null AND " & _
      " ConsCAPRelPrevisaoRecebimentoPorCliente.tipl_tx_Sigla = 'R' AND " & _
      " ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Base < " & FunNuloData(DtpDtBase.Value, NomeSgbd) & " AND " & _
      " ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Pagamento >= " & FunNuloData(DtpDtBase.Value, NomeSgbd) & ")"
    ...
    Else
      ...
      XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
      "ConsCAPRelPrevisaoRecebimentoPorCliente.titu_dt_Pagamento is Null"
      XGT_CONJUNCAO = " AND "
    ...
    If CboObs.BoundText <> "" Then
      XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
      "ConsCAPRelPrevisaoRecebimentoPorCliente.obse_cd_Observacao=" & CboObs.BoundText & " "
      XGT_CONJUNCAO = " AND "
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelTitulosVencidosPorCliente.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    If ChkEmpreendimentos.Value = 1 Then
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelTitulosVencidosPorClienteAgrupados.rpt")
      Set XGR_RELATORIO = RptTitulosVencidosPorClienteAgrupados
    Else
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelTitulosVencidosPorCliente.rpt")
      Set XGR_RELATORIO = RptTitulosVencidosPorCliente
    End If
  
    XGR_RELATORIO.DiscardSavedData '05/12/08 - Patrícia
...
Private Sub Form_Activate()
  Set Formulario = FrmRelTitulosVencidosPorCliente
End Sub

Private Sub Form_Load()
  
  subManutencaoJanelasAtivas "I", "FrmRelTitulosVencidosPorCliente"
