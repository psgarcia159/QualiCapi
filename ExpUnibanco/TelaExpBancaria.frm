...
Begin VB.Form TelaExpBancaria 
   Caption         =   "Exportação Bancária - UNIBANCO"
   ClientHeight    =   5730
   ClientLeft      =   75
   ClientTop       =   1470
   ClientWidth     =   9360
   ...
   Begin Threed.SSPanel PanPesquisa 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(5)=   "LblInstrucao1"
         Tab(0).Control(5).Enabled=   0   'False
         Tab(0).Control(6)=   "LblInstrucao2"
         Tab(0).Control(6).Enabled=   0   'False
         Tab(0).Control(7)=   "LblMensagem1"
         Tab(0).Control(7).Enabled=   0   'False
         Tab(0).Control(8)=   "TxtMensagem1"
         ...
         Tab(0).Control(18)=   "TxtInstrucao1"
         Tab(0).Control(18).Enabled=   0   'False
         Tab(0).Control(19)=   "TxtInstrucao2"
         Tab(0).Control(19).Enabled=   0   'False
         Tab(0).Control(20)=   "CboNaturezasPlanos"
         ...
         Begin TrueDBGrid70.TDBGrid TDBGridObs2 
            ...
            Splits(0)._ColumnProps(15)=   "Column(1)._EditAlways=0"
            Splits(0)._ColumnProps(16)=   "Column(1)._ColStyle=74256"
            Splits(0)._ColumnProps(17)=   "Column(1).Visible=0"
            Splits(0)._ColumnProps(18)=   "Column(1).WrapText=1"
            Splits(0)._ColumnProps(19)=   "Column(1).FetchStyle=1"
            Splits(0)._ColumnProps(20)=   "Column(1).AllowFocus=0"
            Splits(0)._ColumnProps(21)=   "Column(1).Order=2"
...
Private Sub CmdExportar_Click()
  ...
  DlgSalvar.DialogTitle = "Arquivo de Exportação do ITAÚ"
  ...
  XLT_TEXTO = "0" & _
              ...
              Format(Left(DatContaCorrente.Recordset.Fields!coco_tx_Conta, 6), "000000") & _
              Format(Right(FunNuloVal(DatContaCorrente.Recordset.Fields!coco_nr_Dac), 1), "0") & _
              FunZeros(9) & _
  ...
  While Not TDBGrid1.EOF
      If TDBGrid1.Columns("Exp.").Value = "-1" Then
          ...
          XLT_NOME = Left(XFO_EXPORTACAO!focl_tx_RazaoSocial, 30) + Space(30 - Len(Left(XFO_EXPORTACAO!focl_tx_RazaoSocial, 30)))
          ...
          XLT_TEXTO = "1" & _
                      ...
                      FunZeros(10) & _
                      "0" & _
                      Left(TxtMensagem1.Text, 30) & Space(30 - Len(TxtMensagem1.Text)) & _
                      "R$14" & _
                      "5" & _
                      "01" & _
                      ...
                      Format(TxtInstrucao2.Text, "00") & Space(2 - Len(Format(TxtInstrucao2.Text, "00")))
          ...
          Conexao.Execute ("UPDATE Titulos Set titu_tx_ExpBanco='S'," & _
            ...
            XGM_MATRIZLOG(4, 1) = DatContaCorrente.Recordset.Fields!coco_cd_Agencia & " - " & DatContaCorrente.Recordset.Fields!coco_tx_Conta & "-" & DatContaCorrente.Recordset.Fields!coco_nr_Dac
            XGM_MATRIZLOG(5, 1) = XFO_EXPORTACAO!titu_dt_Vencimento
            
            Call subRegistraLog("TelaExpBancaria", "1", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_UNIBANCO))
            '*******************************************************************
...
Private Sub Form_Load()
    ...
    subConectarControleDadosNV DatContaCorrente, "SELECT * FROM ConsGENCCcombo where empr_cd_empresa=" & Int(PCodEmpresa) & " AND banc_cd_codigo=409 ORDER BY coco_tx_Descricao", Estatico
