...
Private Sub botao_conf_Click()
    ...
    If Formulario.Name = "TelaFornecedores" And GridFiltro.Item(xColuna).DataField = "focl_tx_tipo" Then
        Select Case Trim$(UCase(Text1.Text))
            Case "S"
                Text1.Text = "J"
            Case "P"
                Text1.Text = "3"
    ...
    If Trim$(Text1.Text) <> "" Then
       ...
       Filtrou = True
       Guarda_Filtro GridFiltro.Item(xColuna).DataField, FunTrataString(Text1.Text)
       Filtro = FiltroOrig
       xcampo = Filtros(1, 1)
