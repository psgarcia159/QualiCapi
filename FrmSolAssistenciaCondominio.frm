...
Begin VB.Form FrmSolAssistenciaCondominio 
   ...
   End
End
Attribute VB_Name = "FrmSolAssistenciaCondominio"
...
Private Sub Form_Load()
    ...
    XGT_SQL = "SELECT DISTINCT " & _
          ...
          "Empreendimentos.empd_cd_Empreendimento as imov_cd_Imovel, " & _
          "Null As cont_cd_Contrato, " & _
          "Empreendimentos.empd_tx_Nome as focl_tx_RazaoSocial, " & _
          "null as imov_dt_EntregaChaves " & _
          "From Empreendimentos " & _
    "Where  " & _
    "Empreendimentos.empr_cd_Empresa = " & PCodEmpresa & " AND " & _
    "Empreendimentos.empd_cd_Empreendimento = '" & XFT_CODEMPREENDIMENTO & "'"
    ...
    If (XInserir = "A") Then
        XGT_SQL = "SELECT * FROM ConsCapAssistenciaTecnica_Condominio WHERE empr_cd_empresa = " & PCodEmpresa & "" & _
                  " AND assi_tx_Titulo = '" & XFT_CODEMPREENDIMENTO + "." & XLT_ASSISTENCIA & "'"
...
'################################################################################################
        ...
        If (XInserir = "I") Then
            ...
            XGT_SQL = "SELECT  IsNull (MAX(cast (assi_cd_CodigoSeq as int)), 0) + 1 AS assi_cd_CodigoSeq From ConsCapAssistenciaTecnica_Condominio WHERE empr_cd_empresa = " & PCodEmpresa & " AND empd_cd_empreendimento = " & XFT_CODEMPREENDIMENTO & ""
            SubQOpenRecordset XLO_RS, XGT_SQL, "Estatico"
            If Not XLO_RS.EOF Then
        ...
        If (XInserir = "I") Then
            XGT_SQL = "SELECT * FROM AssistenciaTecnicaCondomonio  WHERE ascd_cd_Assistencia = -1 "
    ...
    If (XInserir = "A") Then
    XGT_SQL = "SELECT * FROM AssistenciaTecnicaCondomonio WHERE empr_cd_empresa  = " & PCodEmpresa & " AND empd_cd_Empreendimento = " & XFT_CODEMPREENDIMENTO & " AND assi_cd_CodigoSeq = " & LblNumOrdem.Caption & ""
    SubQOpenRecordset XLO_RS, XGT_SQL, Dinamico
