...
Begin VB.Form TelaExpBancaria 
   Caption         =   "Exportação Bancária - Sudameris"
   ClientHeight    =   5730
   ClientLeft      =   75
   ClientTop       =   1470
   ClientWidth     =   9360
   ...
   Begin Threed.SSPanel PanPesquisa 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(0)=   "LblMesAno"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).Control(1)=   "LblDtExportacao"
         Tab(0).Control(1).Enabled=   0   'False
         Tab(0).Control(2)=   "LblTipoPlano"
         Tab(0).Control(2).Enabled=   0   'False
         Tab(0).Control(3)=   "LblNaturezaPlano"
         Tab(0).Control(3).Enabled=   0   'False
         Tab(0).Control(4)=   "LblCCorrente"
         Tab(0).Control(4).Enabled=   0   'False
         Tab(0).Control(5)=   "LblInstrucao1(0)"
         Tab(0).Control(5).Enabled=   0   'False
         Tab(0).Control(6)=   "LblInstrucao2(1)"
         ...
         Tab(0).Control(16)=   "CboNaturezasPlanos"
         Tab(0).Control(16).Enabled=   0   'False
         Tab(0).Control(17)=   "TxtInstrucao1"
         Tab(0).Control(17).Enabled=   0   'False
         Tab(0).Control(18)=   "TxtInstrucao2"
         Tab(0).Control(18).Enabled=   0   'False
         Tab(0).ControlCount=   19
         TabCaption(1)   =   "Empreendimentos"
         TabPicture(1)   =   "TelaExpBancaria.frx":08E6
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "CmdInserirTodosEmpreendimento"
         Tab(1).Control(1)=   "CmdRemoverTodosEmpreendimento"
         Tab(1).Control(2)=   "CmdInserirEmpreendimento"
         Tab(1).Control(3)=   "CmdRemoverEmpreendimento"
         Tab(1).Control(4)=   "TDBGridEmpr2"
         Tab(1).Control(5)=   "TDBGridEmpr1"
         Tab(1).Control(6)=   "Label1"
         Tab(1).Control(7)=   "LlbEmpreendimento"
         Tab(1).ControlCount=   8
         TabCaption(2)   =   "Moedas"
         TabPicture(2)   =   "TelaExpBancaria.frx":0902
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "FraCorrecao"
         Tab(2).Control(1)=   "CmdInserirTodosMoeda"
         Tab(2).Control(2)=   "CmdRemoverTodosMoeda"
         Tab(2).Control(3)=   "CmdInserirMoeda"
         Tab(2).Control(4)=   "CmdRemoverMoeda"
         Tab(2).Control(5)=   "TDBGridMoeda2"
         Tab(2).Control(6)=   "TDBGridMoeda1"
         ...
         Tab(3).Control(4)=   "CmdInserirTodosObservacao"
         Tab(3).Control(5)=   "CmdRemoverTodosObservacao"
         Tab(3).Control(6)=   "CmdInserirObservacao"
         Tab(3).Control(7)=   "CmdRemoverObservacao"
         ...
         Tab(4).Control(4)=   "TxtMensagem4"
         Tab(4).Control(5)=   "TxtMensagem3"
         Tab(4).Control(6)=   "TxtMensagem2"
         Tab(4).Control(7)=   "TxtMensagem1"
...
Private Sub CmdExportar_Click()
  ...
  DlgSalvar.DialogTitle = "Arquivo de Exportação do Sudameris"
  ...
  XLT_TEXTO = "0" & _
              ...
              "01" & _
              "COBRANCA" & Space(7) & _
              Format(Left(DatContaCorrente.Recordset.Fields!coco_cd_Agencia, 3), "000") & _
              Space(1) & _
              Format(Left(DatContaCorrente.Recordset.Fields!coco_tx_Conta, 8), "00000000") & _
              Space(8) & _
              Mid(PEmpresa, 1, 30) & Space(30 - Len(Mid(PEmpresa, 1, 30))) & _
              Format(DatContaCorrente.Recordset.Fields!banc_cd_Codigo, "000") & _
              "BCO. SUDAMERIS" & Space(15 - Len("BCO. SUDAMERIS")) & _
  ...
  While Not TDBGrid1.EOF
      If TDBGrid1.Columns("Exp.").Value = "-1" Then
          ...
          If OptIndexador1.Value = True Then
            XLF_VALOR = Format(funCalculaCorrecaoMonetaria(XFO_EXPORTACAO, 1, XFO_EXPORTACAO!titu_dt_Vencimento), "standard")
          ElseIf OptIndexador2.Value = True Then
            XLF_VALOR = Format(funCalculaCorrecaoMonetaria(XFO_EXPORTACAO, 2, XFO_EXPORTACAO!titu_dt_Vencimento), "standard")
          Else
            XLF_VALOR = XFO_EXPORTACAO!titu_vl_Parcela
          End If
          ...
          If XFO_EXPORTACAO!clie_tx_EndCorresp = "" And XFO_EXPORTACAO!clie_tx_BairroCorresp = "" _
            ...
            If XLT_TIPO = "02" Then
              XLT_ENDERECO = Left(XFO_EXPORTACAO!focl_tx_Endereco, 35) + Space(35 - Len(Left(XFO_EXPORTACAO!focl_tx_Endereco, 35)))
            ...
            Else
              XLT_ENDERECO = Left(XFO_EXPORTACAO!clie_tx_EndResidencial, 35) + Space(35 - Len(Left(XFO_EXPORTACAO!clie_tx_EndResidencial, 35)))
          ...
          Else
            XLT_ENDERECO = Left(XFO_EXPORTACAO!clie_tx_EndCorresp, 35) + Space(35 - Len(Left(XFO_EXPORTACAO!clie_tx_EndCorresp, 35)))
          ...
          XLT_TEXTO = "1" & _
                      ...
                      Format(FunNuloVal(TxtInstrucao2.Text), "00")
          ...
          XLT_TEXTO = "5" & _
                      TxtMensagem1 & Space(55 - Len(TxtMensagem1.Text)) & _
                      TxtMensagem2 & Space(55 - Len(TxtMensagem2.Text)) & _
                      TxtMensagem3 & Space(55 - Len(TxtMensagem3.Text)) & _
                      TxtMensagem4 & Space(55 - Len(TxtMensagem4.Text)) & _
                      Space(173) & _
                      Format(XLI_NUMSQUENCIAL, "000000")
          ...
          Conexao.Execute ("UPDATE Titulos Set titu_tx_ExpBanco='S'," & _
            ...
            Call subRegistraLog("TelaExpBancaria", "1", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_SUDAMERIS))
            '*******************************************************************
