VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptPrevisaoRecebimentoAnaliticoMensalAgrupados 
   ClientHeight    =   9630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12105
   OleObjectBlob   =   "RptPrevisaoRecebimentoAnaliticoMensalAgrupados.dsx":0000
End
Attribute VB_Name = "RptPrevisaoRecebimentoAnaliticoMensalAgrupados"
...
Private Sub SecFooterProrrogacao2_Format(ByVal pFormattingInfo As Object)
