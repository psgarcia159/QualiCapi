...
Begin VB.Form TelaManTabTiposImoveis 
   Caption         =   "Tabela de Tipos de Imóveis"
   ClientHeight    =   4545
   ClientLeft      =   60
   ClientTop       =   1260
   ClientWidth     =   8910
   ...
   Begin Threed.SSPanel PanTipoImovel 
      Height          =   1515
      Left            =   1905
      TabIndex        =   11
      Top             =   690
      ...
      _ExtentY        =   2672
      _StockProps     =   15
      Caption         =   " Cadastro de Tipo de Imóvel"
      ForeColor       =   16711680
      BackColor       =   14737632
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      Bindings        =   "TelaTiposImoveis.frx":0000
      Height          =   3690
      Left            =   45
      TabIndex        =   13
      Top             =   15
      ...
      Columns(0).DataField=   "tiim_tx_Descricao"
   ...
   Begin MSDataListLib.DataCombo cboLocalizar 
      Bindings        =   "TelaTiposImoveis.frx":0015
      Height          =   315
      Left            =   2760
      TabIndex        =   14
      Top             =   3750
   ...
   End
End
Attribute VB_Name = "TelaManTabTiposImoveis"
...
Private Sub CmdConfirmar_Click()
    ...
    Conexao.BeginTrans
    If PanTipoImovel.Tag = "I" Then
        XLT_SQL = "INSERT INTO TiposImoveis (tiim_tx_Descricao) VALUES ('" & txtDescricao.Text & "')"
              Conexao.Execute XLT_SQL
    Else    'Alteração
        XLT_SQL = "UPDATE TiposImoveis SET tiim_tx_Descricao = '" & txtDescricao.Text & "'" & _
                " WHERE tiim_cd_TipoImovel = " & PanTipoImovel.Tag
        Conexao.Execute XLT_SQL
    End If
    Conexao.CommitTrans
    
    PanTipoImovel.Visible = False
    PanBotoes.Enabled = True
    subHabilitaBotoes
    
    subrecarregadadosNV Adodc1, "", FRM_Ordem, "", FRM_FiltroAtual
    If PanTipoImovel.Tag <> "I" Then
        cboLocalizar.BoundText = PanTipoImovel.Tag
        Adodc1.Recordset.bookmark = cboLocalizar.SelectedItem
    End If
...
Private Sub CmdImprimir_Click()
    Call subImprimeListagemGRID(1, TDBGrid1.PrintInfo, "Listagem de Tipos de Imóveis")
End Sub
...
Private Sub CmdRemoverFiltro_Click()
    ...
    Set Formulario = TelaManTabTiposImoveis
...
Private Sub CmdAlterar_Click()
    ...
    PanTipoImovel.Visible = True
    PanTipoImovel.Enabled = True
    PanTipoImovel.Left = (TDBGrid1.Width - PanTipoImovel.Width) / 2
    PanTipoImovel.Top = (TDBGrid1.Height - PanTipoImovel.Height) / 2
    PanTipoImovel.Tag = Adodc1.Recordset.Fields("tiim_cd_TipoImovel")
    PanTipoImovel.Caption = " Alteração de Tipo de Imóvel"
    subDesabilitaBotoes
    
    txtDescricao.Text = Adodc1.Recordset.Fields("tiim_tx_descricao")
...
Private Sub CmdExcluir_Click()
    ...
    If XLI_OPCAO = 1 Then  'Confirma exclusão
      ...
      Conexao.BeginTrans
      Conexao.Execute "DELETE FROM TiposImoveis WHERE tiim_cd_TipoImovel=" & Adodc1.Recordset.Fields("tiim_cd_TipoImovel")
      Conexao.CommitTrans
      subrecarregadadosNV Adodc1, "", FRM_Ordem, "", FRM_FiltroAtual
      Quantid = Quantid - 1
...
RotuloErro:
    ...
    If Err.Number = -2147467259 Then
      MsgBox "Esse Tipo de Imóvel não pode ser excluído pois já possui algum imóvel relacionado!", vbCritical, "ATENÇÃO"
    End If
    subHabilitaBotoes
End Sub
...
Private Sub CmdInserir_Click()
    ...
    PanTipoImovel.Left = (TDBGrid1.Width - PanTipoImovel.Width) / 2
    PanTipoImovel.Top = (TDBGrid1.Height - PanTipoImovel.Height) / 2
    PanTipoImovel.Caption = " Inserção de Tipo de Imóvel"
    PanTipoImovel.Tag = "I"
    subDesabilitaBotoes
    txtDescricao.Text = ""
    cboLocalizar.Text = ""
...
Private Sub Form_Load()
    ...
    subManutencaoJanelasAtivas "I", "TelaManTabTiposImoveis"
         
    'Associa um banco de dados à tabela TiposImoveis
    subCarregaDadosNV Adodc1, "TiposImoveis", "tiim_tx_Descricao", _
                            "", "SELECT * FROM TiposImoveis"
...
Private Sub Form_Unload(Cancel As Integer)
    subManutencaoJanelasAtivas "R", "TelaManTabTiposImoveis"
End Sub
