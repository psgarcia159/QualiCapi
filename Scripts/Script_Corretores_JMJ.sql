...
CREATE TABLE [dbo].[CorretoresEmpreendimento](
	...
	CONSTANT [PK_COEM01] PRIMARY KEY CLUSTERED 
	(
		[empr_cd_Empresa] 		 ASC,
...
CREATE TABLE [dbo].[CorretoresPagamento](
	[copa_cd_CorretoresPagamento]	[int] IDENTITY(1,1) NOT NULL,
	...
	[comi_cd_Comissoes] 			[int] 					NULL,	-- FK_COMI_COPA
	[nofi_cd_notafiscal]			[int]					NULL,	-- FK_NOFI_COPA
--	[dupl_cd_duplicata]				[int]					NULL,	-- FK_DUPL_COPA
	...
	CONSTRAINT [PK_COPA01] PRIMARY KEY CLUSTERED 
	(
		[copa_cd_CorretoresPagamento] ASC
	)
) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[CorretoresPagamento]  WITH CHECK ADD CONSTRAINT [FK_COMI_COPA] FOREIGN KEY([comi_cd_Comissoes])
 REFERENCES [dbo].[Comissoes] ([comi_cd_Comissoes])
GO

ALTER TABLE [dbo].[CorretoresPagamento] CHECK CONSTRAINT [FK_COMI_COPA]
GO

ALTER TABLE [dbo].[CorretoresPagamento]  WITH CHECK ADD CONSTRAINT [FK_NOFI_COPA] FOREIGN KEY([nofi_cd_notafiscal])
 REFERENCES [dbo].[NotasFiscais] ([nofi_cd_notafiscal])
GO

ALTER TABLE [dbo].[CorretoresPagamento] CHECK CONSTRAINT [FK_NOFI_COPA]
GO

-- ALTER TABLE [dbo].[CorretoresPagamento]  WITH CHECK ADD CONSTRAINT [FK_DUPL_COPA] FOREIGN KEY([dupl_cd_duplicata])
--  REFERENCES [dbo].[Duplicatas] ([dupl_cd_duplicata])
-- GO

-- ALTER TABLE [dbo].[CorretoresPagamento] CHECK CONSTRAINT [FK_DUPL_COPA]
-- GO
