VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptPrevisaoRecebimentoSinteticoMensalAgrupados 
   ClientHeight    =   9630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11460
   OleObjectBlob   =   "RptPrevisaoRecebimentoSinteticoMensalAgrupados.dsx":0000
End
Attribute VB_Name = "RptPrevisaoRecebimentoSinteticoMensalAgrupados"
...
Private Sub SecDetalhe_Format(ByVal pFormattingInfo As Object)
  ...
  Dim XLF_AVISTA As Double
  Dim XLF_SINAL As Double
  Dim XLF_FINANCIAMENTO As Double
  Dim XLF_POUPANCA As Double
  Dim XLF_FGTS As Double
  Dim XLF_OUTROS As Double
