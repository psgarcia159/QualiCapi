VERSION 5.00
Begin {BD4B4E61-F7B8-11D0-964D-00A0C9273C2A} RptTitulosLiquidadosAnalitico 
   ClientHeight    =   7275
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10080
   OleObjectBlob   =   "RptTitulosLiquidadosAnalitico.dsx":0000
End
Attribute VB_Name = "RptTitulosLiquidadosAnalitico"
...
Private Sub SecDetalhe_Format(ByVal pFormattingInfo As Object)
  ...
  XLF_VALORCORRIGIDO = Format(FunCalculoCorrecaoMonetaria(XLO_CAMPOS, XLO_VETOR, XLD_DATABASE), "Standard")
