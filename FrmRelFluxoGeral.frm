...
Begin VB.Form FrmRelFluxoGeral 
   Caption         =   "Relatório Fluxo Geral"
   ClientHeight    =   4860
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9345
   Icon            =   "FrmRelFluxoGeral.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   4860
   ScaleWidth      =   9345
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelFluxoGeral.frx":2AFA
            Picture         =   "FrmRelFluxoGeral.frx":2B16
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelFluxoGeral.frx":2C28
            Height          =   315
            Left            =   1740
            TabIndex        =   13
            Top             =   180
      ...
      Begin VB.Frame FraNaturezaPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelFluxoGeral.frx":2C43
            Left            =   1740
            List            =   "FrmRelFluxoGeral.frx":2C59
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelFluxoGeral.frx":2C94
            Picture         =   "FrmRelFluxoGeral.frx":2CB0
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelFluxoGeral.frx":2DC2
      Height          =   315
      Left            =   1320
      TabIndex        =   26
      Top             =   4440
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelFluxoGeral.frx":2DD7
      Picture         =   "FrmRelFluxoGeral.frx":3229
   End
   ...
   End
End
Attribute VB_Name = "FrmRelFluxoGeral"
...
Private Sub CmdImprimir_Click()
    ...
    FrmRelFluxoGeral.MousePointer = vbHourglass
...
'      " From ConsCAPRelExtratoContrato WHERE "
    ...
    ElseIf (IsNull(DtpInicioPagamento.Value)) And (Not IsNull(DtpFimPagamento.Value)) Then
        XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
        "(titu_dt_Pagamento is null OR ConsCAPRelExtratoContrato.titu_dt_Pagamento <= " & FunNuloData(DtpFimPagamento.Value, NomeSgbd) & ")"
        XGT_CONJUNCAO = " AND "
    ...
    'Por mês de vencimento ou Pagamento
    If XOrigem = "Pagamento" Then
      XGT_SELECAO = XGT_SELECAO & XGT_CONJUNCAO & _
      "ConsCAPRelExtratoContrato.titu_dt_Pagamento is not null"
      XGT_CONJUNCAO = " AND "
    ...
    If XGO_RSRELATORIO.EOF Then
        ...
        FrmRelFluxoGeral.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    FrmVisRelatorios.Caption = "Relatório Fluxo Geral Por Mês de Vencimento"
    
    If XOrigem = "Vencimento" Then
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelFluxoGeralVencimento.rpt")
      Set XGR_RELATORIO = Nothing
      Set XGR_RELATORIO = RptFluxoGeralVencimento
    Else
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelFluxoGeralPagamento.rpt")
      Set XGR_RELATORIO = Nothing
      Set XGR_RELATORIO = RptFluxoGeralPagamento
    End If
...
Private Sub Form_Activate()
  Set Formulario = FrmRelFluxoGeral
End Sub

Private Sub Form_Load()
  subManutencaoJanelasAtivas "I", "FrmRelFluxoGeral"
  ...
  If XOrigem = "Vencimento" Then
    Me.Caption = "Relatório Fluxo Geral Por Mês de Vencimento"
    OptVencimento.Caption = "Vencimento"
  Else
    Me.Caption = "Relatório Fluxo Geral Por Mês de Pagamento"
    OptVencimento.Caption = "Pagamento"
  End If
