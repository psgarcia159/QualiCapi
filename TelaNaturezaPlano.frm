...
Begin VB.Form TelaManTabNaturezasPlanos 
   Caption         =   "Tabela de Natureza de Planos"
   ClientHeight    =   4545
   ClientLeft      =   60
   ClientTop       =   1260
   ClientWidth     =   8910
   ...
   Begin Threed.SSPanel PanNatureza 
      Height          =   1515
      Left            =   1905
      TabIndex        =   11
      Top             =   690
      ...
      _ExtentY        =   2672
      _StockProps     =   15
      Caption         =   " Cadastro de Natureza do Plano"
      ForeColor       =   16711680
      BackColor       =   14737632
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      Bindings        =   "TelaNaturezaPlano.frx":0000
      Height          =   3690
      Left            =   45
      TabIndex        =   13
      Top             =   15
      ...
      Columns(0).DataField=   "napl_tx_descricao"
      ...
      Splits(0)._ColumnProps(1)=   "Column(0).Width=14790"
      Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
      Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=14711"
   ...
   Begin MSDataListLib.DataCombo cboLocalizar 
      Bindings        =   "TelaNaturezaPlano.frx":0015
      Height          =   315
      Left            =   2760
      TabIndex        =   14
      Top             =   3750
      ...
      _Version        =   393216
      Style           =   2
      ListField       =   "napl_tx_descricao"
      BoundColumn     =   "napl_cd_NaturezaPlano"
      Text            =   ""
   End
   ...
   End
End
Attribute VB_Name = "TelaManTabNaturezasPlanos"
...
Private Sub CmdConfirmar_Click()
    ...
    Dim XLO_NATUREZA As New ADODB.Recordset
    ...
    Conexao.BeginTrans
    If PanNatureza.Tag = "I" Then
        'Verifica se já existe a natureza do plano
        SubQOpenRecordset XLO_NATUREZA, "SELECT napl_cd_NaturezaPlano FROM NaturezasPlanos WHERE napl_tx_Descricao= '" & TxtDescricao.Text & "'", Estatico
        If Not XLO_NATUREZA.EOF Then
          MsgBox "Esse natureza de plano já existe", vbCritical + vbOKOnly, "ATENÇÃO"
          XLO_NATUREZA.Close
          Set XLO_NATUREZA = Nothing
          Conexao.CommitTrans
          Exit Sub
        End If
        XLO_NATUREZA.Close
        ...
        XLT_SQL = "INSERT INTO NaturezasPlanos (napl_tx_descricao) VALUES ('" & TxtDescricao.Text & "')"
    ...
    Else    'Alteração
        ...
        SubQOpenRecordset XLO_NATUREZA, "SELECT napl_cd_NaturezaPlano FROM NaturezasPlanos WHERE napl_tx_Descricao= '" & TxtDescricao.Text & "'", Estatico
        If Not XLO_NATUREZA.EOF Then
          If XLO_NATUREZA!napl_cd_NaturezaPlano <> PanNatureza.Tag Then
            MsgBox "Esse natureza de plano já existe", vbCritical + vbOKOnly, "ATENÇÃO"
            XLO_NATUREZA.Close
            Set XLO_NATUREZA = Nothing
            Conexao.CommitTrans
        ...
        XLT_SQL = "UPDATE NaturezasPlanos SET napl_tx_descricao = '" & TxtDescricao.Text & "'" & _
                " WHERE napl_cd_naturezaplano = " & PanNatureza.Tag
        Conexao.Execute XLT_SQL
    End If
    Conexao.CommitTrans
    
    PanNatureza.Visible = False
    ...
    'Adodc1.Refresh
    If PanNatureza.Tag <> "I" Then
        cboLocalizar.BoundText = PanNatureza.Tag
        Adodc1.Recordset.Bookmark = cboLocalizar.SelectedItem
    End If
...
Private Sub CmdImprimir_Click()
    Call subImprimeListagemGRID(1, TDBGrid1.PrintInfo, "Listagem de Natureza dos Planos")
End Sub
...
Private Sub CmdRemoverFiltro_Click()
    ...
    Set Formulario = TelaManTabNaturezasPlanos
...
Private Sub CmdAlterar_Click()
    ...
    PanNatureza.Visible = True
    PanNatureza.Enabled = True
    PanNatureza.Left = (TDBGrid1.Width - PanNatureza.Width) / 2
    PanNatureza.Top = (TDBGrid1.Height - PanNatureza.Height) / 2
    PanNatureza.Tag = Adodc1.Recordset.Fields("napl_cd_naturezaplano")
    PanNatureza.Caption = " Alteração de Natureza do Plano"
    SubDesabilitaBotoes
    
    TxtDescricao.Text = Adodc1.Recordset.Fields("napl_tx_descricao")
...
Private Sub CmdExcluir_Click()
    ...
    If XLI_OPCAO = 1 Then  'Confirma exclusão
       ...
       Conexao.BeginTrans
       Conexao.Execute "DELETE FROM NaturezaPlano WHERE napl_cd_naturezaplano=" & Adodc1.Recordset.Fields("napl_cd_naturezaplano")
       Conexao.CommitTrans
...
Private Sub CmdInserir_Click()
    ...
    PanNatureza.Left = (TDBGrid1.Width - PanNatureza.Width) / 2
    PanNatureza.Top = (TDBGrid1.Height - PanNatureza.Height) / 2
    PanNatureza.Caption = " Inserção de Natureza do Plano"
    PanNatureza.Tag = "I"
    SubDesabilitaBotoes
    TxtDescricao.Text = ""
    cboLocalizar.Text = ""
...
Private Sub Form_Load()
    ...
    subManutencaoJanelasAtivas "I", "TelaManTabNaturezasPlanos"
         
    'Associa um banco de dados à tabela NaturezaPlano
    subCarregaDadosNV Adodc1, "", "napl_tx_descricao", _
                            "", "SELECT * FROM NaturezasPlanos"
...
Private Sub Form_Unload(Cancel As Integer)
    subManutencaoJanelasAtivas "R", "TelaManTabNaturezasPlanos"
End Sub
