...
Begin VB.Form FrmImportacao 
   Caption         =   "Retorno de Pagamento Eletrônico - UNIBANCO"
   ClientHeight    =   1785
   ClientLeft      =   1995
   ClientTop       =   1515
   ClientWidth     =   9120
...
Private Sub CmdConfirmar_Click()
  ...
  While Not EOF(1)
    ...
    If Left(XLT_TEXTO, 1) = "1" Then
      ...
      If Mid(XLT_TEXTO, 18, 11) = XLT_CODEMPRESA Then
    
        If Mid(XLT_TEXTO, 109, 2) = "06" Then
          ...
          If IsNull(XLO_IMPORTACAO!titu_dt_Pagamento) Then
            ...
            Call subRegistraLog("TelaExpBancaria", "2", funCriaDescricaoLog(XGM_MATRIZLOG, EXPORTACAO_CAPI, PAGAMENTO_ELETRONICO_UNIBANCO))
            '*******************************************************************
