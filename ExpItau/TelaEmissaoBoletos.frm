...
Private Sub CmdEmitirBoletos_Click()
    ...
    ' --------------------------------------------------------------------------------------------
    ' CmdImprimir.Enabled = False     ' Desabilita comando/botão de impressão até que sejam validados os pagamentos
    ...
    If Not XLB_SELECIONADO Then
        MsgBox "Não existem pagamentos selecionados.", vbInformation, "ATENÇÃO"
        Exit Sub
    End If
    ...
    ' --------------------------------------------------------------------------------------------
    ' DlgSalvar.DialogTitle = "Arquivo LOG da Emissão de Boletos Itaú"
    ' DlgSalvar.Filter = "Arquivos CSV (*.csv)|*.csv"
    ' DlgSalvar.InitDir = "C:\Temp\"
    ' DlgSalvar.FileName = "BoletosItau-" & Format(Now, "yyyyMMdd-hhmmss") & ".csv"
    ...
    XGT_LOCALARQ = "C:\Temp\BoletosItau-" & Format(Now, "yyyyMMdd-hhmmss") & ".csv"
    ...
    While Not TDBGrid1.EOF
        ...
        If TDBGrid1.Columns("Sel.").Value = "-1" Then
            ...
            If IsDate(TDBGrid1.Columns(6)) Then
                XLT_DATADESCONTO = Format(TDBGrid1.Columns(6), "yyyy-mm-dd")
            Else
                XLT_DATADESCONTO = ""
            End If
...
'            End If
            ...
            FunJsonString("nome_pessoa", RemoverCaracteresEspeciais(Trim(XLT_NOME))) & ", " & _
            FunJsonString("nome_fantasia", RemoverCaracteresEspeciais(Trim(XLT_FANTASIA))) & ", "
            ...
            XLT_JSON = XLT_JSON & _
            FunJsonString("endereco", "{ ", False) & _
            FunJsonString("nome_logradouro", RemoverCaracteresEspeciais(IIf(XLT_ENDERECO <> "", Trim(XLT_ENDERECO), " "))) & ", " & _
            FunJsonString("nome_bairro", RemoverCaracteresEspeciais(IIf(XLT_BAIRRO <> "", Trim(XLT_BAIRRO), " "))) & ", " & _
            FunJsonString("nome_cidade", RemoverCaracteresEspeciais(IIf(XLT_CIDADE <> "", Trim(XLT_CIDADE), " "))) & ", " & _
            ...
            If Me.cboSacadorAvalista.Text <> "" Then
                ...
                XLT_JSON = XLT_JSON & _
                FunJsonString("pessoa", "{ ", False) & _
                FunJsonString("nome_pessoa", RemoverCaracteresEspeciais(Trim(DatEmpresa.Recordset.Fields!empr_tx_razaosocial))) & ", " & _
                FunJsonString("nome_fantasia", RemoverCaracteresEspeciais(Trim(DatEmpresa.Recordset.Fields!empr_tx_fantasia))) & ", "
