...
Begin VB.Form FrmRelExtratoContratoAnaliticoCliente 
   Caption         =   "Relatório Extrato do Contrato - Analítico (Cliente)"
   ClientHeight    =   5190
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9360
   Icon            =   "FrmRelExtratoContratoAnaliticoCliente.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   ScaleHeight     =   5190
   ScaleWidth      =   9360
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame FraIndexador 
         ...
         Begin MSDataListLib.DataCombo CboIndexador 
            Bindings        =   "FrmRelExtratoContratoAnaliticoCliente.frx":2AFA
            Height          =   315
            Left            =   1140
            TabIndex        =   51
            Top             =   240
         ...
         Begin Threed.SSCommand CmdLimparIndexador 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnaliticoCliente.frx":2B15
            Picture         =   "FrmRelExtratoContratoAnaliticoCliente.frx":2F67
         End
      ...
      Begin VB.Frame FraTipoPlano 
         ...
         Begin VB.ComboBox CboNaturezasPlanos 
            Height          =   315
            ItemData        =   "FrmRelExtratoContratoAnaliticoCliente.frx":3079
            Left            =   1260
            List            =   "FrmRelExtratoContratoAnaliticoCliente.frx":308F
         ...
         Begin Threed.SSCommand CmdLimparTipoPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnaliticoCliente.frx":30CA
            Picture         =   "FrmRelExtratoContratoAnaliticoCliente.frx":30E6
         End
         Begin MSDataListLib.DataCombo CboTiposPlanos 
            Bindings        =   "FrmRelExtratoContratoAnaliticoCliente.frx":31F8
            Height          =   315
            Left            =   1260
            TabIndex        =   13
            Top             =   180
         ...
         Begin Threed.SSCommand CmdLimparNaturezaPlano 
            ...
            _ExtentY        =   556
            _StockProps     =   78
            MouseIcon       =   "FrmRelExtratoContratoAnaliticoCliente.frx":3213
            Picture         =   "FrmRelExtratoContratoAnaliticoCliente.frx":322F
         End
   ...
   Begin MSDataListLib.DataCombo CboObs 
      Bindings        =   "FrmRelExtratoContratoAnaliticoCliente.frx":3341
      Height          =   315
      Left            =   1380
      TabIndex        =   22
      Top             =   4800
   ...
   Begin Threed.SSCommand CmdLimparObs 
      ...
      _ExtentY        =   556
      _StockProps     =   78
      MouseIcon       =   "FrmRelExtratoContratoAnaliticoCliente.frx":3356
      Picture         =   "FrmRelExtratoContratoAnaliticoCliente.frx":37A8
   End
   ...
   End
End
Attribute VB_Name = "FrmRelExtratoContratoAnaliticoCliente"
...
Private Sub CmdCancelar_Click()
    Set RptExtratoContratoAnaliticoCliente = Nothing
    Set RptExtratoContratoAnaliticoDestacadoCliente = Nothing
    Unload Me
End Sub

Private Sub CmdImprimir_Click()

'RELATÓRIO INTERNO É CASE SENSITIVE
    ...
    FrmRelExtratoContratoAnaliticoCliente.MousePointer = vbHourglass
    XLB_DESTACADO = False
   ...
   XLT_SQL = XLT_SQL & _
    ...
    If XLB_DESTACADO Then
      ...
      Set RptExtratoContratoAnaliticoDestacadoCliente = Nothing
      Set XGR_RELATORIO = RptExtratoContratoAnaliticoDestacadoCliente
    Else
      'Set XGR_RELATORIO = XGR_APLICACAO.OpenReport(App.Path + "\Relatorios\RelExtratoContratoAnalitico.rpt")
      Set RptExtratoContratoAnaliticoCliente = Nothing
      Set XGR_RELATORIO = RptExtratoContratoAnaliticoCliente
    End If
    ...
    FrmRelExtratoContratoAnaliticoCliente.MousePointer = vbDefault
...
Private Sub Form_Activate()
  Set Formulario = FrmRelExtratoContratoAnaliticoCliente
End Sub

Private Sub Form_Load()
  
  subManutencaoJanelasAtivas "I", "FrmRelExtratoContratoAnaliticoCliente"
